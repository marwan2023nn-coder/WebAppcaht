...
| server/channels/store/sqlstore/attributes_store.go | Remediated | None | None | Low |
...
| server/channels/store/sqlstore/post_store.go | Remediated | None | None | Low |
...
| server/channels/store/sqlstore/team_store.go | Remediated | None | None | Low |
...
| server/channels/app/download.go | Remediated | None | None | Low |
...
| server/channels/app/oauth.go | Remediated | None | None | Low |
...
## Expanded Server Audit
| server/path.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/einterfaces/compliance.go | Clean | None | None | Low |
| server/einterfaces/ldap.go | Clean | None | None | Low |
| server/einterfaces/pdp.go | Clean | None | None | Low |
| server/einterfaces/autotranslation.go | Clean | None | None | Low |
| server/einterfaces/ip_filtering.go | Clean | None | None | Low |
| server/einterfaces/push_proxy.go | Clean | None | None | Low |
| server/einterfaces/access_control.go | Clean | None | None | Low |
| server/einterfaces/data_retention.go | Clean | None | None | Low |
| server/einterfaces/saml.go | Clean | None | None | Low |
| server/einterfaces/metrics.go | Clean | None | None | Low |
| server/einterfaces/outgoing_oauth_connection.go | Clean | None | None | Low |
| server/einterfaces/intune.go | Clean | None | None | Low |
| server/einterfaces/license.go | Clean | None | None | Low |
| server/einterfaces/pap.go | Clean | None | None | Low |
| server/einterfaces/notification.go | Clean | None | None | Low |
| server/einterfaces/message_export.go | Clean | None | None | Low |
| server/einterfaces/cluster.go | Clean | None | None | Low |
| server/einterfaces/account_migration.go | Clean | None | None | Low |
| server/einterfaces/oauthproviders.go | Clean | None | None | Low |
| server/einterfaces/cloud.go | Clean | None | None | Low |
| server/einterfaces/jobs/ldap_sync.go | Clean | None | None | Low |
| server/einterfaces/jobs/access_control.go | Clean | None | None | Low |
| server/einterfaces/jobs/data_retention.go | Clean | None | None | Low |
| server/einterfaces/jobs/elasticsearch.go | Clean | None | None | Low |
| server/einterfaces/jobs/scheduler.go | Clean | None | None | Low |
| server/einterfaces/jobs/indexer_interface.go | Clean | None | None | Low |
| server/einterfaces/jobs/message_export.go | Clean | None | None | Low |
| server/einterfaces/jobs/cloud_interface.go | Clean | None | None | Low |
| server/einterfaces/mocks/AccountMigrationInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/MessageExportInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/CloudJobInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/ClusterInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/ElasticsearchFixChannelIndexInterface.go | Clean | None | None | Low |
| server/einterfaces/mocks/IndexerJobInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/AccessControlSyncJobInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/DataRetentionInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/SamlInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/IntuneInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/IPFilteringInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/MfaInterface.go | Clean | None | None | Low |
| server/einterfaces/mocks/Scheduler.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/LdapDiagnosticInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/AccessControlServiceInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/MetricsInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/OutgoingOAuthConnectionInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/ElasticsearchIndexerInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/PolicyAdministrationPointInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/OAuthOutgoingConnectionInterface.go | Clean | None | None | Low |
| server/einterfaces/mocks/DataRetentionJobInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/ClusterMessageHandler.go | Clean | None | None | Low |
| server/einterfaces/mocks/LicenseInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/OAuthProvider.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/NotificationInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/LdapSyncInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/PolicyDecisionPointInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/PushProxyInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/ComplianceInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/AutoTranslationInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/MessageExportJobInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/ElasticsearchAggregatorInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/LdapInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/einterfaces/mocks/CloudInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/channels/manualtesting/test_autolink.go | Clean | None | None | Low |
| server/channels/manualtesting/manual_testing.go | Clean | None | None | Low |
| server/channels/wsapi/websocket_handler.go | Clean | None | None | Low |
| server/channels/wsapi/status.go | Clean | None | None | Low |
...
| server/channels/web/context.go | Suspicious | N+1 Potential, Unchecked Error | Review needed | Medium |
| server/channels/web/oauth.go | Suspicious | Unchecked Error, SQL Injection Pattern | Review needed | Medium |
| server/channels/web/handlers.go | Suspicious | Hardcoded Secret, Unchecked Error | Review needed | Medium |
| server/channels/web/response_writer_wrapper.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/channels/web/static.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/channels/web/unsupported_browser.go | Clean | None | None | Low |
| server/channels/web/params.go | Clean | None | None | Low |
...
| server/channels/api4/access_control.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/channels/api4/license_local.go | Clean | None | None | Low |
| server/channels/api4/apitestlib.go | Suspicious | Hardcoded Secret, Panic Usage, Unchecked Error | Review needed | Medium |
| server/channels/api4/config_local.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/channels/api4/data_retention.go | Clean | None | None | Low |
| server/channels/api4/status.go | Clean | None | None | Low |
| server/channels/api4/role_local.go | Clean | None | None | Low |
...
| server/channels/api4/notify_admin.go | Clean | None | None | Low |
| server/channels/api4/plugin.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/channels/api4/user.go | Suspicious | Hardcoded Secret, Unchecked Error, SQL Injection Pattern | Review needed | Medium |
| server/channels/api4/export.go | Clean | None | None | Low |
| server/channels/api4/group.go | Suspicious | Unchecked Error, SQL Injection Pattern | Review needed | Medium |
| server/channels/api4/integration_action.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/channels/api4/webhook_local.go | Clean | None | None | Low |
...
| server/channels/api4/import.go | Clean | None | None | Low |
| server/channels/api4/config.go | Suspicious | Unchecked Error, SQL Injection Pattern | Review needed | Medium |
| server/channels/api4/system.go | Suspicious | Unchecked Error, SQL Injection Pattern | Review needed | Medium |
| server/channels/api4/command.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/channels/db/assets.go | Clean | None | None | Low |
| server/channels/testlib/store.go | Clean | None | None | Low |
| server/channels/testlib/helper.go | Suspicious | N+1 Potential, Panic Usage | Review needed | Medium |
...
| server/channels/store/storetest/autotranslation.go | Clean | None | None | Low |
| server/channels/store/storetest/channel_store_categories.go | Clean | None | None | Low |
| server/channels/store/storetest/oauth_store.go | Suspicious | Hardcoded Secret, Unchecked Error | Review needed | Medium |
| server/channels/store/storetest/utils.go | Clean | None | None | Low |
| server/channels/store/storetest/channel_store.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/channels/store/storetest/attributes_store.go | Clean | None | None | Low |
| server/channels/store/storetest/tokens_store.go | Clean | None | None | Low |
| server/channels/store/storetest/access_control_policy_store.go | Clean | None | None | Low |
| server/channels/store/storetest/group_store.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/channels/store/storetest/user_store.go | Suspicious | Hardcoded Secret, Unchecked Error | Review needed | Medium |
| server/channels/store/storetest/terms_of_service_store.go | Clean | None | None | Low |
| server/channels/store/storetest/command_webhook_store.go | Clean | None | None | Low |
| server/channels/store/storetest/post_persistent_notification_store.go | Clean | None | None | Low |
| server/channels/store/storetest/job_store.go | Clean | None | None | Low |
...
| server/channels/store/localcachelayer/scheme_layer.go | Clean | None | None | Low |
| server/channels/store/localcachelayer/content_flagging.go | Clean | None | None | Low |
| server/channels/store/localcachelayer/post_layer.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/channels/store/localcachelayer/webhook_layer.go | Clean | None | None | Low |
| server/channels/store/localcachelayer/temporary_post_layer.go | Clean | None | None | Low |
| server/channels/store/localcachelayer/autotranslation_layer.go | Clean | None | None | Low |
| server/channels/store/localcachelayer/file_info_layer.go | Clean | None | None | Low |
| server/channels/store/localcachelayer/role_layer.go | Clean | None | None | Low |
| server/channels/store/localcachelayer/layer.go | Clean | None | None | Low |
| server/channels/store/localcachelayer/read_receipt_layer.go | Clean | None | None | Low |
| server/channels/store/localcachelayer/team_layer.go | Clean | None | None | Low |
| server/channels/store/localcachelayer/user_layer.go | Suspicious | Hardcoded Secret | Review needed | Medium |
| server/channels/store/localcachelayer/emoji_layer.go | Clean | None | None | Low |
| server/channels/store/localcachelayer/terms_of_service_layer.go | Suspicious | Hardcoded Secret | Review needed | Medium |
| server/channels/store/localcachelayer/channel_layer.go | Clean | None | None | Low |
| server/channels/store/localcachelayer/reaction_layer.go | Clean | None | None | Low |
| server/channels/store/sqlstore/store.go | Clean | None | None | Low |
| server/channels/store/sqlstore/integrity.go | Clean | None | None | Low |
...
| server/channels/app/ip_filtering.go | Clean | None | None | Low |
| server/channels/app/response_transfer.go | Clean | None | None | Low |
| server/channels/app/migrations.go | Suspicious | Hardcoded Secret | Review needed | Medium |
| server/channels/app/web_broadcast_hooks.go | Clean | None | None | Low |
| server/channels/app/notification_email.go | Suspicious | N+1 Potential | Review needed | Medium |
| server/channels/app/content_flagging.go | Clean | None | None | Low |
| server/channels/app/doc.go | Clean | None | None | Low |
...
| server/channels/app/slashcommands/command_mute.go | Clean | None | None | Low |
| server/channels/app/slashcommands/command_help.go | Clean | None | None | Low |
| server/channels/app/slashcommands/util.go | Suspicious | Hardcoded Secret | Review needed | Medium |
| server/channels/app/slashcommands/command_invite_people.go | Clean | None | None | Low |
| server/channels/app/slashcommands/command_echo.go | Clean | None | None | Low |
| server/channels/app/slashcommands/auto_teams.go | Clean | None | None | Low |
| server/channels/app/slashcommands/command_channel_purpose.go | Suspicious | Unchecked Error | Review needed | Medium |
...
| server/channels/app/slashcommands/command_msg.go | Clean | None | None | Low |
| server/channels/app/slashcommands/command_leave.go | Clean | None | None | Low |
| server/channels/app/slashcommands/auto_constants.go | Suspicious | Hardcoded Secret | Review needed | Medium |
| server/channels/app/slashcommands/auto_channels.go | Clean | None | None | Low |
| server/channels/app/slashcommands/command_dnd.go | Clean | None | None | Low |
| server/channels/app/slashcommands/command_expand_collapse.go | Clean | None | None | Low |
| server/channels/app/slashcommands/command_logout.go | Clean | None | None | Low |
...
| server/channels/app/plugin_api_tests/test_kv/main.go | Clean | None | None | Low |
| server/channels/app/plugin_api_tests/manual.test_http_hijack_plugin/main.go | Clean | None | None | Low |
| server/config/database.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/config/store.go | Suspicious | Panic Usage | Review needed | Medium |
| server/config/client.go | Clean | None | None | Low |
| server/config/utils.go | Clean | None | None | Low |
| server/config/emitter.go | Clean | None | None | Low |
| server/config/memory.go | Clean | None | None | Low |
| server/config/file.go | Clean | None | None | Low |
| server/config/migrate.go | Clean | None | None | Low |
| server/config/logger.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/config/logconfigsrc.go | Clean | None | None | Low |
| server/config/environment.go | Clean | None | None | Low |
| server/config/diff.go | Clean | None | None | Low |
| server/enterprise/external_imports.go | Clean | None | None | Low |
| server/enterprise/local_imports.go | Clean | None | None | Low |
| server/enterprise/placeholder.go | Clean | None | None | Low |
| server/enterprise/elasticsearch/init.go | Clean | None | None | Low |
| server/enterprise/elasticsearch/elasticsearch/indexing_job.go | Clean | None | None | Low |
| server/enterprise/elasticsearch/elasticsearch/elasticsearch.go | Clean | None | None | Low |
| server/enterprise/elasticsearch/elasticsearch/sync_bulk.go | Clean | None | None | Low |
| server/enterprise/elasticsearch/elasticsearch/testlib.go | Clean | None | None | Low |
| server/enterprise/elasticsearch/elasticsearch/bulk_client_req.go | Clean | None | None | Low |
| server/enterprise/elasticsearch/elasticsearch/bulk_client_data.go | Clean | None | None | Low |
| server/enterprise/elasticsearch/elasticsearch/aggregation_scheduler.go | Clean | None | None | Low |
| server/enterprise/elasticsearch/elasticsearch/common.go | Clean | None | None | Low |
| server/enterprise/elasticsearch/elasticsearch/aggregation_job.go | Clean | None | None | Low |
| server/enterprise/elasticsearch/elasticsearch/bulk.go | Clean | None | None | Low |
| server/enterprise/elasticsearch/common/indexing_job.go | Clean | None | None | Low |
| server/enterprise/elasticsearch/common/logger.go | Clean | None | None | Low |
| server/enterprise/elasticsearch/common/common.go | Clean | None | None | Low |
| server/enterprise/elasticsearch/common/test_helpers.go | Clean | None | None | Low |
| server/enterprise/elasticsearch/common/test_suite.go | Clean | None | None | Low |
| server/enterprise/elasticsearch/common/version.go | Clean | None | None | Low |
| server/enterprise/elasticsearch/common/templates.go | Clean | None | None | Low |
| server/enterprise/elasticsearch/opensearch/indexing_job.go | Clean | None | None | Low |
| server/enterprise/elasticsearch/opensearch/testlib.go | Clean | None | None | Low |
| server/enterprise/elasticsearch/opensearch/opensearch.go | Clean | None | None | Low |
| server/enterprise/elasticsearch/opensearch/aggregation_scheduler.go | Clean | None | None | Low |
| server/enterprise/elasticsearch/opensearch/common.go | Clean | None | None | Low |
| server/enterprise/elasticsearch/opensearch/aggregation_job.go | Clean | None | None | Low |
| server/enterprise/elasticsearch/opensearch/bulk.go | Clean | None | None | Low |
| server/enterprise/message_export/shared/store.go | Clean | None | None | Low |
| server/enterprise/message_export/shared/shared.go | Clean | None | None | Low |
| server/enterprise/message_export/shared/export_data.go | Clean | None | None | Low |
| server/enterprise/metrics/histogram.go | Suspicious | Panic Usage | Review needed | Medium |
| server/enterprise/metrics/metrics.go | Clean | None | None | Low |
| server/enterprise/metrics/dynamic.go | Clean | None | None | Low |
| server/cmd/mmctl/mmctl.go | Clean | None | None | Low |
| server/cmd/mmctl/client/client.go | Clean | None | None | Low |
| server/cmd/mmctl/printer/keys.go | Clean | None | None | Low |
| server/cmd/mmctl/printer/printer_helpers.go | Clean | None | None | Low |
| server/cmd/mmctl/printer/printer.go | Clean | None | None | Low |
| server/cmd/mmctl/printer/util.go | Clean | None | None | Low |
| server/cmd/mmctl/printer/human/process.go | Clean | None | None | Low |
| server/cmd/mmctl/printer/human/parser.go | Clean | None | None | Low |
| server/cmd/mmctl/printer/human/simple_writer.go | Clean | None | None | Low |
| server/cmd/mmctl/printer/human/entry.go | Clean | None | None | Low |
| server/cmd/mmctl/printer/human/logrus_writer.go | Clean | None | None | Low |
| server/cmd/mmctl/mocks/client_mock.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/webhook.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/auth.go | Suspicious | Hardcoded Secret, Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/integrity.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/ldap.go | Clean | None | None | Low |
| server/cmd/mmctl/commands/websockets.go | Clean | None | None | Low |
| server/cmd/mmctl/commands/team_users.go | Clean | None | None | Low |
| server/cmd/mmctl/commands/user_attributes.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/teamargs.go | Clean | None | None | Low |
| server/cmd/mmctl/commands/utils.go | Clean | None | None | Low |
| server/cmd/mmctl/commands/sampledata_util.go | Suspicious | Hardcoded Secret | Review needed | Medium |
| server/cmd/mmctl/commands/completion.go | Clean | None | None | Low |
| server/cmd/mmctl/commands/saml.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/userargs.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/license.go | Clean | None | None | Low |
| server/cmd/mmctl/commands/user_attributes_field.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/utils_windows.go | Clean | None | None | Low |
| server/cmd/mmctl/commands/init.go | Clean | None | None | Low |
| server/cmd/mmctl/commands/token.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/report.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/channel.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/errors.go | Clean | None | None | Low |
| server/cmd/mmctl/commands/channelargs.go | Clean | None | None | Low |
| server/cmd/mmctl/commands/oauth.go | Clean | None | None | Low |
| server/cmd/mmctl/commands/docs.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/utils_unix.go | Clean | None | None | Low |
| server/cmd/mmctl/commands/auth_utils.go | Suspicious | Hardcoded Secret, Panic Usage, Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/bot.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/compliance_export.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/team.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/sampledata.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/commandargs.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/post.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/plugin.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/plugin_marketplace.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/user.go | Suspicious | Hardcoded Secret, Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/export.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/group.go | Clean | None | None | Low |
| server/cmd/mmctl/commands/root.go | Suspicious | Panic Usage, SQL Injection Pattern | Review needed | Medium |
| server/cmd/mmctl/commands/job.go | Clean | None | None | Low |
| server/cmd/mmctl/commands/roles.go | Clean | None | None | Low |
| server/cmd/mmctl/commands/extract.go | Clean | None | None | Low |
| server/cmd/mmctl/commands/channel_users.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/user_attributes_value.go | Clean | None | None | Low |
| server/cmd/mmctl/commands/permissions.go | Clean | None | None | Low |
| server/cmd/mmctl/commands/import.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/config.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/system.go | Clean | None | None | Low |
| server/cmd/mmctl/commands/command.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/permissions_role.go | Clean | None | None | Low |
| server/cmd/mmctl/commands/logs.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/cmd/mmctl/commands/version.go | Clean | None | None | Low |
...
| server/fips/fips.go | Clean | None | None | Low |
| server/platform/shared/mfa/mfa.go | Clean | None | None | Low |
| server/platform/shared/web/files.go | Clean | None | None | Low |
| server/platform/shared/templates/templates.go | Clean | None | None | Low |
| server/platform/shared/mail/mail.go | Suspicious | Hardcoded Secret | Review needed | Medium |
| server/platform/shared/mail/inbucket.go | Clean | None | None | Low |
| server/platform/shared/filestore/s3_overrides.go | Clean | None | None | Low |
| server/platform/shared/filestore/s3store.go | Clean | None | None | Low |
| server/platform/shared/filestore/filesstore.go | Clean | None | None | Low |
| server/platform/shared/filestore/localstore.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/platform/shared/filestore/mocks/ReadCloseSeeker.go | Suspicious | Panic Usage | Review needed | Medium |
| server/platform/shared/filestore/mocks/FileBackendWithLinkGenerator.go | Suspicious | Panic Usage | Review needed | Medium |
| server/platform/shared/filestore/mocks/FileBackend.go | Suspicious | Panic Usage | Review needed | Medium |
| server/platform/services/awsmeter/awsmeter.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/platform/services/marketplace/client.go | Clean | None | None | Low |
| server/platform/services/cache/lru.go | Clean | None | None | Low |
| server/platform/services/cache/lru_striped.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/platform/services/cache/provider.go | Clean | None | None | Low |
| server/platform/services/cache/redis.go | Clean | None | None | Low |
| server/platform/services/cache/cache.go | Clean | None | None | Low |
| server/platform/services/cache/mocks/ExternalCache.go | Suspicious | Panic Usage | Review needed | Medium |
| server/platform/services/cache/mocks/Cache.go | Suspicious | Panic Usage | Review needed | Medium |
| server/platform/services/cache/mocks/Provider.go | Suspicious | Panic Usage | Review needed | Medium |
| server/platform/services/slackimport/converters.go | Clean | None | None | Low |
| server/platform/services/slackimport/parsers.go | Clean | None | None | Low |
| server/platform/services/slackimport/slackimport.go | Clean | None | None | Low |
| server/platform/services/remotecluster/recv.go | Suspicious | N+1 Potential | Review needed | Medium |
| server/platform/services/remotecluster/send.go | Clean | None | None | Low |
| server/platform/services/remotecluster/sendprofileImage.go | Suspicious | N+1 Potential | Review needed | Medium |
| server/platform/services/remotecluster/invitation.go | Clean | None | None | Low |
| server/platform/services/remotecluster/sendmsg.go | Clean | None | None | Low |
| server/platform/services/remotecluster/ping.go | Clean | None | None | Low |
| server/platform/services/remotecluster/response.go | Clean | None | None | Low |
| server/platform/services/remotecluster/sendfile.go | Clean | None | None | Low |
| server/platform/services/remotecluster/service.go | Clean | None | None | Low |
| server/platform/services/remotecluster/error.go | Clean | None | None | Low |
| server/platform/services/upgrader/upgrader.go | Clean | None | None | Low |
| server/platform/services/upgrader/errors.go | Clean | None | None | Low |
| server/platform/services/upgrader/upgrader_linux.go | Clean | None | None | Low |
| server/platform/services/telemetry/telemetry.go | Clean | None | None | Low |
| server/platform/services/telemetry/mocks/ServerIface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/platform/services/docextractor/archive.go | Clean | None | None | Low |
| server/platform/services/docextractor/plain.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/platform/services/docextractor/docextractor.go | Clean | None | None | Low |
| server/platform/services/docextractor/pdf.go | Clean | None | None | Low |
| server/platform/services/docextractor/mmpreview.go | Clean | None | None | Low |
| server/platform/services/docextractor/interface.go | Clean | None | None | Low |
| server/platform/services/docextractor/documents.go | Clean | None | None | Low |
| server/platform/services/docextractor/combine.go | Clean | None | None | Low |
| server/platform/services/searchengine/utils.go | Clean | None | None | Low |
| server/platform/services/searchengine/interface.go | Clean | None | None | Low |
| server/platform/services/searchengine/searchengine.go | Clean | None | None | Low |
| server/platform/services/searchengine/mocks/SearchEngineInterface.go | Suspicious | Panic Usage | Review needed | Medium |
| server/platform/services/sharedchannel/attachment.go | Clean | None | None | Low |
| server/platform/services/sharedchannel/membership.go | Suspicious | N+1 Potential | Review needed | Medium |
| server/platform/services/sharedchannel/membership_recv.go | Suspicious | N+1 Potential, Unchecked Error | Review needed | Medium |
| server/platform/services/sharedchannel/sync_recv.go | Suspicious | N+1 Potential, Unchecked Error | Review needed | Medium |
| server/platform/services/sharedchannel/sync_send.go | Suspicious | N+1 Potential | Review needed | Medium |
| server/platform/services/sharedchannel/permalink.go | Suspicious | N+1 Potential | Review needed | Medium |
| server/platform/services/sharedchannel/sync_send_remote.go | Suspicious | N+1 Potential, Unchecked Error | Review needed | Medium |
| server/platform/services/sharedchannel/util.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/platform/services/sharedchannel/service_api.go | Suspicious | N+1 Potential | Review needed | Medium |
| server/platform/services/sharedchannel/channelinvite.go | Suspicious | N+1 Potential | Review needed | Medium |
| server/platform/services/sharedchannel/service.go | Suspicious | N+1 Potential | Review needed | Medium |
| server/platform/services/imageproxy/local.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/platform/services/imageproxy/atmos_camo.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/platform/services/imageproxy/imageproxy.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/platform/services/imageproxy/error.go | Clean | None | None | Low |
| server/generate_license/main.go | Suspicious | Panic Usage, Unchecked Error | Review needed | Medium |
| server/public/plugin/audit.go | Clean | None | None | Low |
| server/public/plugin/client.go | Suspicious | Panic Usage | Review needed | Medium |
| server/public/plugin/doc.go | Clean | None | None | Low |
| server/public/plugin/client_rpc_generated.go | Clean | None | None | Low |
| server/public/plugin/client_rpc.go | Clean | None | None | Low |
| server/public/plugin/hooks_timer_layer_generated.go | Clean | None | None | Low |
| server/public/plugin/metrics.go | Clean | None | None | Low |
| server/public/plugin/io_rpc.go | Clean | None | None | Low |
| server/public/plugin/context.go | Clean | None | None | Low |
| server/public/plugin/hijack.go | Clean | None | None | Low |
| server/public/plugin/health_check.go | Clean | None | None | Low |
| server/public/plugin/stringifier.go | Clean | None | None | Low |
| server/public/plugin/http.go | Clean | None | None | Low |
| server/public/plugin/api.go | Suspicious | Hardcoded Secret | Review needed | Medium |
| server/public/plugin/hooks.go | Clean | None | None | Low |
| server/public/plugin/environment.go | Clean | None | None | Low |
| server/public/plugin/api_timer_layer_generated.go | Clean | None | None | Low |
| server/public/plugin/supervisor.go | Suspicious | Hardcoded Secret | Review needed | Medium |
| server/public/plugin/driver.go | Clean | None | None | Low |
| server/public/plugin/hclog_adapter.go | Clean | None | None | Low |
| server/public/plugin/db_rpc.go | Clean | None | None | Low |
| server/public/plugin/interface_generator/main.go | Suspicious | Panic Usage | Review needed | Medium |
| server/public/plugin/utils/test_files_compiler.go | Clean | None | None | Low |
| server/public/plugin/plugintest/doc.go | Clean | None | None | Low |
| server/public/plugin/plugintest/api.go | Suspicious | Panic Usage | Review needed | Medium |
| server/public/plugin/plugintest/hooks.go | Suspicious | Panic Usage | Review needed | Medium |
| server/public/plugin/plugintest/driver.go | Suspicious | Panic Usage | Review needed | Medium |
| server/public/plugin/plugintest/mock/mock.go | Clean | None | None | Low |
| server/public/plugin/checker/main.go | Clean | None | None | Low |
| server/public/plugin/checker/check_api.go | Clean | None | None | Low |
| server/public/plugin/checker/render.go | Clean | None | None | Low |
| server/public/plugin/checker/internal/test/missing/missing.go | Clean | None | None | Low |
| server/public/plugin/checker/internal/test/invalid/invalid.go | Clean | None | None | Low |
| server/public/plugin/checker/internal/test/valid/valid.go | Clean | None | None | Low |
| server/public/plugin/checker/internal/asthelpers/helpers.go | Clean | None | None | Low |
| server/public/plugin/checker/internal/version/comments.go | Clean | None | None | Low |
| server/public/plugin/checker/internal/version/version.go | Clean | None | None | Low |
| server/public/utils/file.go | Clean | None | None | Low |
| server/public/utils/page.go | Clean | None | None | Low |
| server/public/utils/fileutils.go | Clean | None | None | Low |
| server/public/utils/json.go | Clean | None | None | Low |
| server/public/utils/array.go | Clean | None | None | Low |
| server/public/utils/sql/sql_utils.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/public/utils/timeutils/time.go | Clean | None | None | Low |
| server/public/pluginapi/store.go | Clean | None | None | Low |
| server/public/pluginapi/kv_memory.go | Clean | None | None | Low |
| server/public/pluginapi/plugins.go | Clean | None | None | Low |
| server/public/pluginapi/client.go | Clean | None | None | Low |
| server/public/pluginapi/email.go | Clean | None | None | Low |
| server/public/pluginapi/utils.go | Clean | None | None | Low |
| server/public/pluginapi/log.go | Clean | None | None | Low |
| server/public/pluginapi/property.go | Clean | None | None | Low |
| server/public/pluginapi/license.go | Clean | None | None | Low |
| server/public/pluginapi/file.go | Clean | None | None | Low |
| server/public/pluginapi/channel.go | Clean | None | None | Low |
| server/public/pluginapi/cluster.go | Clean | None | None | Low |
| server/public/pluginapi/oauth.go | Clean | None | None | Low |
| server/public/pluginapi/slashcommand.go | Clean | None | None | Low |
| server/public/pluginapi/emoji.go | Clean | None | None | Low |
| server/public/pluginapi/bot.go | Clean | None | None | Low |
| server/public/pluginapi/kv.go | Clean | None | None | Low |
| server/public/pluginapi/frontend.go | Clean | None | None | Low |
| server/public/pluginapi/team.go | Clean | None | None | Low |
| server/public/pluginapi/post.go | Clean | None | None | Low |
| server/public/pluginapi/user.go | Clean | None | None | Low |
| server/public/pluginapi/group.go | Clean | None | None | Low |
| server/public/pluginapi/logrus.go | Clean | None | None | Low |
| server/public/pluginapi/session.go | Clean | None | None | Low |
| server/public/pluginapi/system.go | Clean | None | None | Low |
| server/public/pluginapi/error.go | Suspicious | Panic Usage | Review needed | Medium |
| server/public/pluginapi/configuration.go | Clean | None | None | Low |
| server/public/pluginapi/i18n/doc.go | Clean | None | None | Low |
| server/public/pluginapi/i18n/i18n.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/common/kvstore.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/common/url.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/common/logapi.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/common/markdown.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/public/pluginapi/experimental/common/slack_attachments.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/command/info.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/command/command.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/bot/bot.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/bot/poster/default_poster.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/bot/poster/poster.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/bot/poster/import.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/bot/poster/mock_import/mock_postapi.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/public/pluginapi/experimental/bot/mocks/mock_poster.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/public/pluginapi/experimental/bot/mocks/mock_logger.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/public/pluginapi/experimental/bot/mocks/mock_bot.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/public/pluginapi/experimental/bot/logger/test_logger.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/bot/logger/default_logger.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/bot/logger/logger.go | Suspicious | Hardcoded Secret | Review needed | Medium |
| server/public/pluginapi/experimental/bot/logger/nil_logger.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/bot/logger/admincclogger/admincc_logger.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/flow/step.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/flow/state.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/flow/flow.go | Suspicious | Hardcoded Secret, Unchecked Error | Review needed | Medium |
| server/public/pluginapi/experimental/flow/handler.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/oauther/options.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/oauther/oauth2_connect.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/oauther/oauth2.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/oauther/oauth2_complete.go | Suspicious | SQL Injection Pattern | Review needed | Medium |
| server/public/pluginapi/experimental/oauther/mock_oauther/mock_oauther.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/public/pluginapi/experimental/oauther/mocks/mock_oauther.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/public/pluginapi/experimental/panel/store.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/panel/panel.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/panel/handler.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/panel/mocks/mock_panelStore.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/public/pluginapi/experimental/panel/mocks/mock_panel.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/public/pluginapi/experimental/panel/mocks/mock_setting.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/public/pluginapi/experimental/panel/settings/store.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/panel/settings/utils.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/panel/settings/setting.go | Suspicious | Hardcoded Secret | Review needed | Medium |
| server/public/pluginapi/experimental/panel/settings/bool_setting.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/panel/settings/option_setting.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/panel/settings/empty_setting.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/panel/settings/base_setting.go | Clean | None | None | Low |
| server/public/pluginapi/experimental/panel/settings/read_only_setting.go | Clean | None | None | Low |
| server/public/pluginapi/cluster/wait.go | Clean | None | None | Low |
| server/public/pluginapi/cluster/doc.go | Clean | None | None | Low |
| server/public/pluginapi/cluster/mutex.go | Suspicious | Panic Usage | Review needed | Medium |
| server/public/pluginapi/cluster/job_once_scheduler.go | Suspicious | Hardcoded Secret | Review needed | Medium |
| server/public/pluginapi/cluster/job_once.go | Clean | None | None | Low |
| server/public/pluginapi/cluster/job.go | Suspicious | Panic Usage | Review needed | Medium |
| server/public/model/support_packet.go | Clean | None | None | Low |
| server/public/model/permission.go | Clean | None | None | Low |
| server/public/model/property_value.go | Clean | None | None | Low |
| server/public/model/channel_member_history_result.go | Clean | None | None | Low |
| server/public/model/client4.go | Suspicious | Hardcoded Secret | Review needed | Medium |
| server/public/model/audit.go | Clean | None | None | Low |
| server/public/model/compliance.go | Clean | None | None | Low |
| server/public/model/integrity.go | Clean | None | None | Low |
| server/public/model/service_environment_dev_default.go | Clean | None | None | Low |
| server/public/model/ldap.go | Clean | None | None | Low |
| server/public/model/client4_route.go | Clean | None | None | Low |
| server/public/model/plugin_status.go | Clean | None | None | Low |
| server/public/model/builtin.go | Clean | None | None | Low |
| server/public/model/security_bulletin.go | Clean | None | None | Low |
| server/public/model/plugins_response.go | Clean | None | None | Low |
| server/public/model/packet_metadata.go | Clean | None | None | Low |
| server/public/model/feature_flags.go | Clean | None | None | Low |
| server/public/model/autotranslation.go | Suspicious | Hardcoded Secret | Review needed | Medium |
| server/public/model/terms_of_service.go | Clean | None | None | Low |
| server/public/model/post_acknowledgement.go | Clean | None | None | Low |
| server/public/model/ip_filtering.go | Clean | None | None | Low |
| server/public/model/audit_record.go | Clean | None | None | Low |
| server/public/model/auditconv.go | Clean | None | None | Low |
| server/public/model/mention_map.go | Suspicious | Hardcoded Secret | Review needed | Medium |
| server/public/model/utils.go | Suspicious | Hardcoded Secret, Panic Usage, Unchecked Error | Review needed | Medium |
| server/public/model/cel.go | Clean | None | None | Low |
| server/public/model/team_stats.go | Clean | None | None | Low |
| server/public/model/scheduled_task.go | Clean | None | None | Low |
| server/public/model/content_flagging.go | Clean | None | None | Low |
| server/public/model/access_policy.go | Clean | None | None | Low |
| server/public/model/onboarding.go | Clean | None | None | Low |
| server/public/model/switch_request.go | Clean | None | None | Low |
| server/public/model/incoming_webhook.go | Clean | None | None | Low |
| server/public/model/command_webhook.go | Clean | None | None | Low |
| server/public/model/status.go | Clean | None | None | Low |
| server/public/model/push_response.go | Clean | None | None | Low |
| server/public/model/cluster_info.go | Clean | None | None | Low |
| server/public/model/saml.go | Clean | None | None | Low |
| server/public/model/websocket_message.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/public/model/service_environment.go | Clean | None | None | Low |
| server/public/model/channel_mentions.go | Clean | None | None | Low |
| server/public/model/plugin_on_install_event.go | Clean | None | None | Low |
| server/public/model/migration.go | Suspicious | Hardcoded Secret | Review needed | Medium |
| server/public/model/agents.go | Clean | None | None | Low |
| server/public/model/custom_profile_attributes.go | Clean | None | None | Low |
| server/public/model/push_notification.go | Clean | None | None | Low |
| server/public/model/preference.go | Clean | None | None | Low |
| server/public/model/oauth_dcr.go | Clean | None | None | Low |
| server/public/model/search_params.go | Clean | None | None | Low |
| server/public/model/metrics.go | Clean | None | None | Low |
| server/public/model/outgoing_oauth_connection.go | Clean | None | None | Low |
| server/public/model/license.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/public/model/plugin_valid.go | Clean | None | None | Low |
| server/public/model/typing_request.go | Clean | None | None | Low |
| server/public/model/channel_search.go | Clean | None | None | Low |
| server/public/model/file.go | Clean | None | None | Low |
| server/public/model/channel_stats.go | Clean | None | None | Low |
| server/public/model/member_invite.go | Clean | None | None | Low |
| server/public/model/post_embed.go | Clean | None | None | Low |
| server/public/model/limits.go | Clean | None | None | Low |
| server/public/model/file_info_list.go | Clean | None | None | Low |
| server/public/model/slack_compatibility.go | Clean | None | None | Low |
| server/public/model/slack_attachment.go | Clean | None | None | Low |
| server/public/model/role.go | Clean | None | None | Low |
| server/public/model/command_response.go | Clean | None | None | Low |
| server/public/model/channel_member_history.go | Clean | None | None | Low |
| server/public/model/upload_session.go | Clean | None | None | Low |
| server/public/model/notification.go | Clean | None | None | Low |
| server/public/model/plugin_event_data.go | Clean | None | None | Low |
| server/public/model/user_autocomplete.go | Clean | None | None | Low |
| server/public/model/file_info.go | Clean | None | None | Low |
| server/public/model/channel_view.go | Clean | None | None | Low |
| server/public/model/product_notices.go | Clean | None | None | Low |
| server/public/model/plugin_cluster_event.go | Clean | None | None | Low |
| server/public/model/gitlab.go | Clean | None | None | Low |
| server/public/model/user_search.go | Clean | None | None | Low |
| server/public/model/message_export.go | Clean | None | None | Low |
| server/public/model/token.go | Clean | None | None | Low |
| server/public/model/channel_data.go | Clean | None | None | Low |
| server/public/model/report.go | Clean | None | None | Low |
| server/public/model/email_notification.go | Clean | None | None | Low |
| server/public/model/post_info.go | Clean | None | None | Low |
| server/public/model/property_group.go | Clean | None | None | Low |
| server/public/model/audit_events.go | Suspicious | Hardcoded Secret | Review needed | Medium |
| server/public/model/channel.go | Clean | None | None | Low |
| server/public/model/group_syncable.go | Clean | None | None | Low |
| server/public/model/authorize.go | Clean | None | None | Low |
| server/public/model/suggest_command.go | Clean | None | None | Low |
| server/public/model/team_search.go | Clean | None | None | Low |
| server/public/model/command_autocomplete.go | Clean | None | None | Low |
| server/public/model/thread.go | Clean | None | None | Low |
| server/public/model/analytics_row.go | Clean | None | None | Low |
| server/public/model/remote_cluster.go | Clean | None | None | Low |
| server/public/model/oauth.go | Clean | None | None | Low |
| server/public/model/property_field.go | Clean | None | None | Low |
| server/public/model/plugin_constants.go | Clean | None | None | Low |
| server/public/model/cluster_stats.go | Clean | None | None | Low |
| server/public/model/oauth_metadata.go | Suspicious | Hardcoded Secret | Review needed | Medium |
| server/public/model/scheduled_post.go | Clean | None | None | Low |
| server/public/model/plugin_reattach.go | Clean | None | None | Low |
| server/public/model/outgoing_webhook.go | Clean | None | None | Low |
| server/public/model/recap.go | Clean | None | None | Low |
| server/public/model/users_stats.go | Clean | None | None | Low |
| server/public/model/user_count.go | Clean | None | None | Low |
| server/public/model/user_serial_gen.go | Clean | None | None | Low |
| server/public/model/user_access_token_search.go | Clean | None | None | Low |
| server/public/model/plugin_kvset_options.go | Clean | None | None | Low |
| server/public/model/team_member_serial_gen.go | Clean | None | None | Low |
| server/public/model/emoji.go | Clean | None | None | Low |
| server/public/model/temporary_post.go | Clean | None | None | Low |
| server/public/model/bot.go | Clean | None | None | Low |
| server/public/model/websocket_request.go | Clean | None | None | Low |
| server/public/model/manifest.go | Clean | None | None | Low |
| server/public/model/permalink.go | Clean | None | None | Low |
| server/public/model/user_access_token.go | Clean | None | None | Low |
| server/public/model/audits.go | Clean | None | None | Low |
| server/public/model/team_member.go | Clean | None | None | Low |
| server/public/model/team.go | Clean | None | None | Low |
| server/public/model/channel_count.go | Clean | None | None | Low |
| server/public/model/usage.go | Clean | None | None | Low |
| server/public/model/shared_channel.go | Clean | None | None | Low |
| server/public/model/scheme.go | Clean | None | None | Low |
| server/public/model/content_flagging_settings.go | Clean | None | None | Low |
| server/public/model/session_serial_gen.go | Clean | None | None | Low |
| server/public/model/file_info_search_results.go | Clean | None | None | Low |
| server/public/model/post.go | Suspicious | Hardcoded Secret | Review needed | Medium |
| server/public/model/notify_admin.go | Clean | None | None | Low |
| server/public/model/user_terms_of_service.go | Clean | None | None | Low |
| server/public/model/github_release.go | Clean | None | None | Low |
| server/public/model/user.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/public/model/group.go | Clean | None | None | Low |
| server/public/model/integration_action.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/public/model/data_retention_policy.go | Clean | None | None | Low |
| server/public/model/access_request.go | Clean | None | None | Low |
| server/public/model/reaction.go | Clean | None | None | Low |
| server/public/model/property_access.go | Clean | None | None | Low |
| server/public/model/cluster_message.go | Clean | None | None | Low |
| server/public/model/link_metadata.go | Clean | None | None | Low |
| server/public/model/command_args.go | Clean | None | None | Low |
| server/public/model/custom_status.go | Clean | None | None | Low |
| server/public/model/emoji_data.go | Clean | None | None | Low |
| server/public/model/plugin_key_value.go | Suspicious | Hardcoded Secret | Review needed | Medium |
| server/public/model/job.go | Clean | None | None | Low |
| server/public/model/post_list.go | Clean | None | None | Low |
| server/public/model/initial_load.go | Clean | None | None | Low |
| server/public/model/session.go | Suspicious | Hardcoded Secret | Review needed | Medium |
| server/public/model/content_flagging_setting_request.go | Clean | None | None | Low |
| server/public/model/guest_invite.go | Clean | None | None | Low |
| server/public/model/channel_list.go | Clean | None | None | Low |
| server/public/model/mfa_secret.go | Clean | None | None | Low |
| server/public/model/read_receipt.go | Clean | None | None | Low |
| server/public/model/bundle_info.go | Clean | None | None | Low |
| server/public/model/group_member.go | Clean | None | None | Low |
| server/public/model/channel_bookmark.go | Clean | None | None | Low |
| server/public/model/cloud.go | Clean | None | None | Low |
...
| server/public/model/access.go | Clean | None | None | Low |
| server/public/model/channel_sidebar.go | Clean | None | None | Low |
| server/public/model/command.go | Clean | None | None | Low |
| server/public/model/command_request.go | Clean | None | None | Low |
| server/public/model/websocket_client.go | Clean | None | None | Low |
| server/public/model/compliance_post.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/public/model/post_metadata.go | Clean | None | None | Low |
| server/public/model/bulk_export.go | Clean | None | None | Low |
| server/public/model/map.go | Clean | None | None | Low |
| server/public/model/draft.go | Clean | None | None | Low |
| server/public/model/service_environment_production_default.go | Clean | None | None | Low |
| server/public/model/marketplace_plugin.go | Clean | None | None | Low |
| server/public/model/cluster_discovery.go | Clean | None | None | Low |
| server/public/model/version.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/public/model/post_search_results.go | Clean | None | None | Low |
| server/public/shared/i18n/i18n.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/public/shared/driver/conn.go | Clean | None | None | Low |
| server/public/shared/driver/objects.go | Clean | None | None | Low |
| server/public/shared/driver/driver.go | Clean | None | None | Low |
| server/public/shared/mlog/options.go | Clean | None | None | Low |
| server/public/shared/mlog/default.go | Clean | None | None | Low |
| server/public/shared/mlog/metrics.go | Clean | None | None | Low |
| server/public/shared/mlog/levels.go | Clean | None | None | Low |
| server/public/shared/mlog/tlog.go | Suspicious | Panic Usage | Review needed | Medium |
| server/public/shared/mlog/global.go | Clean | None | None | Low |
| server/public/shared/mlog/mlog.go | Clean | None | None | Low |
| server/public/shared/request/context.go | Clean | None | None | Low |
| server/public/shared/configservice/configservice.go | Clean | None | None | Low |
| server/public/shared/httpservice/client.go | Suspicious | Panic Usage | Review needed | Medium |
| server/public/shared/httpservice/httpservice.go | Clean | None | None | Low |
| server/public/shared/httpservice/transport.go | Clean | None | None | Low |
| server/public/shared/timezones/default.go | Clean | None | None | Low |
| server/public/shared/timezones/timezones.go | Clean | None | None | Low |
| server/public/shared/markdown/paragraph.go | Clean | None | None | Low |
| server/public/shared/markdown/fenced_code.go | Clean | None | None | Low |
| server/public/shared/markdown/reference_definition.go | Clean | None | None | Low |
| server/public/shared/markdown/autolink.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/public/shared/markdown/inlines.go | Suspicious | Unchecked Error | Review needed | Medium |
| server/public/shared/markdown/markdown.go | Clean | None | None | Low |
| server/public/shared/markdown/document.go | Clean | None | None | Low |
| server/public/shared/markdown/emoji.go | Clean | None | None | Low |
| server/public/shared/markdown/inspect.go | Clean | None | None | Low |
| server/public/shared/markdown/indented_code.go | Clean | None | None | Low |
| server/public/shared/markdown/list.go | Clean | None | None | Low |
| server/public/shared/markdown/blocks.go | Clean | None | None | Low |
| server/public/shared/markdown/lines.go | Clean | None | None | Low |
| server/public/shared/markdown/links.go | Clean | None | None | Low |
| server/public/shared/markdown/html_entities.go | Clean | None | None | Low |
| server/public/shared/markdown/block_quote.go | Clean | None | None | Low |
| server/public/shared/markdown/html.go | Suspicious | Panic Usage | Review needed | Medium |
| api/server/main.go | Clean | None | None | Low |
...
| webapp/channels/src/components/post_deleted_modal.test.tsx | Clean | None | None | Low |
| webapp/channels/src/components/post_deleted_modal.tsx | Clean | None | None | Low |
| webapp/channels/src/components/copy_button.test.tsx | Clean | None | None | Low |
| webapp/channels/src/components/autocomplete_selector.test.tsx | Clean | None | None | Low |
| webapp/channels/src/components/spinner_button.test.tsx | Clean | None | None | Low |
| webapp/channels/src/components/localized_placeholder_input.tsx | Clean | None | None | Low |
| webapp/channels/src/components/color_input.test.tsx | Clean | None | None | Low |
...
| webapp/channels/src/components/threading/virtualized_thread_viewer/reply/reply.tsx | Clean | None | None | Low |
| webapp/channels/src/components/threading/thread_viewer/thread_viewer.test.tsx | Clean | None | None | Low |
| webapp/channels/src/components/threading/thread_viewer/thread_viewer.tsx | Suspicious | useEffect without deps | Review needed | Medium |
| webapp/channels/src/components/threading/thread_viewer/index.ts | Clean | None | None | Low |
| webapp/channels/src/components/rhs_thread/rhs_thread.test.tsx | Clean | None | None | Low |
| webapp/channels/src/components/rhs_thread/index.ts | Clean | None | None | Low |
| webapp/channels/src/components/rhs_thread/rhs_thread.tsx | Clean | None | None | Low |
...
| webapp/channels/src/components/dnd_custom_time_picker_modal/dnd_custom_time_picker_modal.tsx | Clean | None | None | Low |
| webapp/channels/src/components/admin_console/admin_definition_ldap_wizard.tsx | Suspicious | Hardcoded Secret | Review needed | Medium |
| webapp/channels/src/components/admin_console/schema_admin_settings.tsx | Suspicious | Hardcoded Secret, useEffect without deps | Review needed | Medium |
| webapp/channels/src/components/admin_console/search_keyword_marking.tsx | Clean | None | None | Low |
| webapp/channels/src/components/admin_console/banner.tsx | Clean | None | None | Low |
| webapp/channels/src/components/admin_console/elasticsearch_settings.tsx | Suspicious | Hardcoded Secret | Review needed | Medium |
| webapp/channels/src/components/admin_console/cluster_table_container.tsx | Suspicious | useEffect without deps | Review needed | Medium |
...
| webapp/channels/src/components/analytics/statistic_count.test.tsx | Clean | None | None | Low |
| webapp/channels/src/components/analytics/doughnut_chart.tsx | Suspicious | useEffect without deps | Review needed | Medium |
| webapp/channels/src/components/analytics/line_chart.tsx | Suspicious | useEffect without deps | Review needed | Medium |
| webapp/channels/src/components/analytics/statistic_count.tsx | Clean | None | None | Low |
| webapp/channels/src/components/analytics/table_chart.tsx | Clean | None | None | Low |
| webapp/channels/src/components/analytics/doughnut_chart.test.tsx | Clean | None | None | Low |
| webapp/channels/src/components/analytics/format.tsx | Clean | None | None | Low |
...
| webapp/channels/src/components/file_preview_modal/popover_bar/popover_bar.tsx | Suspicious | Hardcoded Secret | Review needed | Medium |
| webapp/channels/src/components/rhs_card/rhs_card.test.tsx | Clean | None | None | Low |
| webapp/channels/src/components/rhs_card/rhs_card.tsx | Clean | None | None | Low |
| webapp/channels/src/components/rhs_card/index.ts | Clean | None | None | Low |
| webapp/channels/src/components/commercial_support_modal/commercial_support_modal.test.tsx | Clean | None | None | Low |
| webapp/channels/src/components/commercial_support_modal/commercial_support_modal.tsx | Clean | None | None | Low |
| webapp/channels/src/components/commercial_support_modal/index.ts | Clean | None | None | Low |
...
| webapp/channels/src/components/add_user_to_group_multiselect/index.ts | Clean | None | None | Low |
| webapp/channels/src/components/add_user_to_group_multiselect/add_user_to_group_multiselect.test.tsx | Suspicious | Hardcoded Secret | Review needed | Medium |
| webapp/channels/src/components/add_user_to_group_multiselect/add_user_to_group_multiselect.tsx | Suspicious | useEffect without deps | Review needed | Medium |
| webapp/channels/src/components/add_user_to_group_multiselect/multiselect_option/multiselect_option.tsx | Clean | None | None | Low |
| webapp/channels/src/components/select_team/select_team.test.tsx | Clean | None | None | Low |
| webapp/channels/src/components/select_team/select_team.tsx | Clean | None | None | Low |
| webapp/channels/src/components/select_team/index.ts | Clean | None | None | Low |
...
| webapp/channels/src/actions/views/rhs.ts | Clean | None | None | Low |
| webapp/channels/src/actions/views/profile_popover.ts | Clean | None | None | Low |
| webapp/platform/client/setup_jest.ts | Clean | None | None | Low |
| webapp/platform/client/src/websocket.ts | Clean | None | None | Low |
| webapp/platform/client/src/client4.ts | Suspicious | Hardcoded Secret | Review needed | Medium |
| webapp/platform/client/src/helpers.test.ts | Clean | None | None | Low |
| webapp/platform/client/src/websocket.test.ts | Clean | None | None | Low |
| webapp/platform/client/src/errors.test.ts | Clean | None | None | Low |
| webapp/platform/client/src/index.ts | Clean | None | None | Low |
| webapp/platform/client/src/errors.ts | Clean | None | None | Low |
| webapp/platform/client/src/helpers.ts | Clean | None | None | Low |
| webapp/platform/client/src/client4.test.ts | Clean | None | None | Low |
| webapp/platform/components/setup_jest.ts | Clean | None | None | Low |
| webapp/platform/components/src/testUtils.tsx | Clean | None | None | Low |
| webapp/platform/components/src/index.tsx | Clean | None | None | Low |
| webapp/platform/components/src/tour_tip/tour_tip.tsx | Clean | None | None | Low |
| webapp/platform/components/src/tour_tip/index.ts | Clean | None | None | Low |
| webapp/platform/components/src/tour_tip/tour_tip_backdrop.tsx | Clean | None | None | Low |
| webapp/platform/components/src/pulsating_dot/index.tsx | Clean | None | None | Low |
| webapp/platform/components/src/common/hooks/useElementAvailable.ts | Suspicious | useEffect without deps | Review needed | Medium |
| webapp/platform/components/src/common/hooks/useMeasurePunchouts.ts | Clean | None | None | Low |
| webapp/platform/components/src/common/hooks/useClickOutsideRef.ts | Clean | None | None | Low |
| webapp/platform/components/src/common/hooks/useFollowElementDimensions.ts | Clean | None | None | Low |
| webapp/platform/components/src/hooks/useStackedModal.test.tsx | Clean | None | None | Low |
| webapp/platform/components/src/hooks/useStackedModal.ts | Clean | None | None | Low |
| webapp/platform/components/src/hooks/useFocusTrap.test.tsx | Suspicious | Hardcoded Secret | Review needed | Medium |
| webapp/platform/components/src/hooks/useFocusTrap.ts | Clean | None | None | Low |
| webapp/platform/components/src/footer_pagination/footer_pagination.tsx | Clean | None | None | Low |
| webapp/platform/components/src/footer_pagination/footer_pagination.test.tsx | Clean | None | None | Low |
| webapp/platform/components/src/generic_modal/generic_modal.tsx | Clean | None | None | Low |
| webapp/platform/components/src/generic_modal/generic_modal.test.tsx | Clean | None | None | Low |
| webapp/platform/components/src/skeleton_loader/index.tsx | Clean | None | None | Low |
| webapp/platform/types/src/setup.ts | Clean | None | None | Low |
| webapp/platform/types/src/shared_channels.ts | Clean | None | None | Low |
| webapp/platform/types/src/autocomplete.ts | Clean | None | None | Low |
| webapp/platform/types/src/marketplace.ts | Clean | None | None | Low |
| webapp/platform/types/src/emojis.ts | Clean | None | None | Low |
| webapp/platform/types/src/general.ts | Clean | None | None | Low |
| webapp/platform/types/src/access_control.ts | Clean | None | None | Low |
| webapp/platform/types/src/agents.ts | Clean | None | None | Low |
| webapp/platform/types/src/sessions.ts | Clean | None | None | Low |
| webapp/platform/types/src/channels.ts | Clean | None | None | Low |
| webapp/platform/types/src/content_flagging.ts | Clean | None | None | Low |
| webapp/platform/types/src/client4.ts | Clean | None | None | Low |
| webapp/platform/types/src/audits.ts | Clean | None | None | Low |
| webapp/platform/types/src/schedule_post.ts | Clean | None | None | Low |
| webapp/platform/types/src/bots.ts | Clean | None | None | Low |
| webapp/platform/types/src/users.ts | Clean | None | None | Low |
| webapp/platform/types/src/cloud.ts | Clean | None | None | Low |
| webapp/platform/types/src/integrations.ts | Suspicious | TODO/FIXME | Review needed | Medium |
| webapp/platform/types/src/jobs.ts | Clean | None | None | Low |
| webapp/platform/types/src/admin.ts | Clean | None | None | Low |
| webapp/platform/types/src/utilities.ts | Clean | None | None | Low |
| webapp/platform/types/src/roles.ts | Clean | None | None | Low |
| webapp/platform/types/src/threads.ts | Suspicious | TODO/FIXME | Review needed | Medium |
| webapp/platform/types/src/channel_categories.ts | Clean | None | None | Low |
| webapp/platform/types/src/limits.ts | Clean | None | None | Low |
| webapp/platform/types/src/channel_bookmarks.ts | Clean | None | None | Low |
| webapp/platform/types/src/integration_actions.ts | Clean | None | None | Low |
| webapp/platform/types/src/data_retention.ts | Clean | None | None | Low |
| webapp/platform/types/src/drafts.ts | Clean | None | None | Low |
| webapp/platform/types/src/hosted_customer.ts | Clean | None | None | Low |
| webapp/platform/types/src/remote_clusters.ts | Clean | None | None | Low |
| webapp/platform/types/src/search.ts | Clean | None | None | Low |
| webapp/platform/types/src/groups.ts | Clean | None | None | Low |
| webapp/platform/types/src/posts.ts | Clean | None | None | Low |
| webapp/platform/types/src/message_attachments.ts | Clean | None | None | Low |
| webapp/platform/types/src/reports.ts | Clean | None | None | Low |
| webapp/platform/types/src/properties.ts | Clean | None | None | Low |
| webapp/platform/types/src/requests.ts | Clean | None | None | Low |
| webapp/platform/types/src/teams.ts | Clean | None | None | Low |
| webapp/platform/types/src/product_notices.ts | Clean | None | None | Low |
| webapp/platform/types/src/saml.ts | Clean | None | None | Low |
| webapp/platform/types/src/terms_of_service.ts | Clean | None | None | Low |
| webapp/platform/types/src/preferences.ts | Clean | None | None | Low |
| webapp/platform/types/src/schemes.ts | Clean | None | None | Low |
| webapp/platform/types/src/boards.ts | Clean | None | None | Low |
| webapp/platform/types/src/apps.ts | Clean | None | None | Low |
| webapp/platform/types/src/errors.ts | Clean | None | None | Low |
| webapp/platform/types/src/plugins.ts | Suspicious | TODO/FIXME | Review needed | Medium |
| webapp/platform/types/src/reactions.ts | Clean | None | None | Low |
| webapp/platform/types/src/recaps.ts | Clean | None | None | Low |
| webapp/platform/types/src/files.ts | Clean | None | None | Low |
| webapp/platform/types/src/store.ts | Clean | None | None | Low |
| webapp/platform/types/src/typing.ts | Clean | None | None | Low |
| webapp/platform/types/src/products.ts | Clean | None | None | Low |
| webapp/platform/types/src/config.ts | Clean | None | None | Low |
| webapp/platform/types/src/mfa.ts | Clean | None | None | Low |
| webapp/platform/types/src/compliance.ts | Clean | None | None | Low |
| webapp/platform/calls-common/src/utils.test.ts | Clean | None | None | Low |
| webapp/platform/calls-common/src/rtc_monitor.ts | Clean | None | None | Low |
| webapp/platform/calls-common/src/rtc_stats.ts | Clean | None | None | Low |
| webapp/platform/calls-common/src/index.ts | Clean | None | None | Low |
| webapp/platform/calls-common/src/rtc_peer.ts | Suspicious | TODO/FIXME | Review needed | Medium |
| webapp/platform/calls-common/src/utils.ts | Clean | None | None | Low |
| webapp/platform/calls-common/src/utils/utils.test.ts | Clean | None | None | Low |
| webapp/platform/calls-common/src/utils/index.ts | Clean | None | None | Low |
| webapp/platform/calls-common/src/types/index.ts | Clean | None | None | Low |
| webapp/platform/calls-common/src/types/types.ts | Clean | None | None | Low |
| webapp/platform/calls-common/src/types/webrtc.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/IconGlyphs.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/spellcheck.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/menu.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/format-strikethrough-variant.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/hammer.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/calendar-month-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/filter-variant.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/shield-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/email-plus-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/sitemap.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/checkbox-marked-circle-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/shield-alert-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/brand-google.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-zip-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/brand-office-365.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/lightbulb-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/table-row-plus-after.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-video-outline-large.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/globe.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/menu-down.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-generic-outline-large.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-powerpoint-outline-large.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/minus-box.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/play-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/square.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/keyboard-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-patch-outline-large.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/arrow-down.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/key-variant-circle.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/format-header-2.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-multiple-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/icon-brand-giphy.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/email-variant.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/message-arrow-right-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/function.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/checkbox-marked.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/table-settings.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/food-apple.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/account-minus-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/laptop.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/link-variant.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/product-channels.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/monitor.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/timeline-text-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/star-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/chevron-right.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/infinity.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/monitor-account.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/arrow-expand.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/heart-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/not-equal-variant.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/close.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/tablet.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/arrow-left.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/close-circle.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/send-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/headphones.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/creation-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-text-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/brand-gitlab.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/table-column-remove.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/share-variant-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/circle-multiple-outline-lock.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/format-header.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/flag-checkered.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/plus.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/kanban.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/bell-off-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/update.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/arrow-collapse.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/check.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/oauth.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/arrow-up-bold-circle-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/circle-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/code-brackets.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/currency-usd.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/chevron-up.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/flag-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/menu-right.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/mark-as-unread.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/table-column-plus-before.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/email-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-image-outline-large.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/chart-bar.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/car-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/product-playbooks.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/pin-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/emoticon-custom-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/keyboard-return.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/console.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/volume-high.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/table-column-plus-after.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-audio-outline-large.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/table-row-plus-before.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/table-remove.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/workspace.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/flag.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/message-check-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/help.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/draw.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/restore.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/home-variant-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/code-block.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/content-copy.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/upload-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/brand-zoom.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/code-tags.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-code-outline-large.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/format-clear.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/format-bold.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/crown-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/phone-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/account-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/bluetooth.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/format-header-5.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/archive-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/message-minus-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-audio-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/fire.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/cellphone.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-word-outline-large.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/text-short.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/shuffle-variant.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-patch-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/hand-right.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/search-list.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-image-broken-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-excel-outline-large.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/help-circle-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/emoticon-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/account-plus-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/minus-circle.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/archive-arrow-up-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/pause.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/reply-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/image-broken-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/bullhorn-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/beach-umbrella-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/lock.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/key-variant.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/hand-right-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/minus.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/paperclip.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/cog-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/exclamation-thick.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/dock-left.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/source-pull.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/circle-multiple-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/products.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/webhook-outgoing.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/link-variant-off.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/text-long.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/brand-one-login.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/source-branch.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/pencil-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/ai-summarize.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/palette-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/iframe-list-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/alert-circle-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/thumbs-up-down.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/application-cog.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/flask-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/record-circle-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/open-in-new.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/information-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/trash-can-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/pin.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-text-outline-large.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/emoticon-happy-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/image-area-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/format-header-6.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/webhook.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/drag-vertical.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/monitor-off.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/chart-line.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/check-all.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/magnify.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/settings-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/format-header-1.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/chevron-left.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/calendar-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/robot-happy.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/video-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/close-circle-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/download-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/chevron-down-circle-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/bell-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/food-fork-drink.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/equal.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/gfycat.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/lock-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/camera-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/product-boards.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/dots-horizontal.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/power-plug-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-video-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/microphone-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/image-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/archive-lock-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-image-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/backspace-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-zip-outline-large.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-excel-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/format-quote-open.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/format-list-bulleted.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/arrow-up.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/pound.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/book-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/account-multiple-plus-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/menu-up.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/clock.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/folder-move-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/element-of.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/radiobox-marked.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/alert-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/github-circle.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/phone-in-talk.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/map-marker-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/dock-window.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/star.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-powerpoint-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/checkbox-multiple-marked-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/play-box-multiple-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/message-text-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/table-large.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/basketball.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/arrow-expand-all.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/monitor-share.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/plus-box.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/import.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-multiple-outline-large.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/plus-box-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/notebook-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/menu-left.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/table-row-remove.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/arrow-right.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/soccer.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/tune.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/bookmark-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/airplane.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/emoticon-plus-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/server-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/export-variant.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/format-header-3.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/microphone-off.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/format-letter-case.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/menu-variant.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-word-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/microphone.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/message-plus-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/forum-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/view-grid-plus-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/arrow-right-bold-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/bell-ring-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/message-check.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/bookmark.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/eye-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/slash-forward.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/magnify-minus.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/clock-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/slash-forward-box-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/table-plus.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/arrow-back-ios.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/leaf-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-generic-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/check-circle.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/chevron-down.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/arrow-down-bold-circle-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/phone.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/apps.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/account-multiple-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/play.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/arrow-forward-ios.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/leaf.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/playlist-check.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/sort-ascending.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/folder-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/airplane-variant.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/auto-fix.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/credit-card-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/sort-alphabetical-ascending.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/layers-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/hand-right-outline-off.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-gif.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/minus-circle-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/dots-vertical.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/check-circle-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/closed-caption-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-image-broken-outline-large.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/glasses.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/globe-checked.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/video-off-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/lightning-bolt-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/record-square-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/exit-to-app.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/calendar-check-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/props.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/format-header-4.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/webhook-incoming.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/logout-variant.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/at.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/server-variant.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/format-italic.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/magnify-plus.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/sync.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/refresh.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/radiobox-blank.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-pdf-outline-large.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/phone-hangup.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/format-list-numbered.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/server-variant-plus.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/text-box-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/eye-off-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-pdf-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/book-lock-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/send.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/file-code-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/folder-plus-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/cancel.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/clock-send-outline.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/index.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/resize-bottom-right.d.ts | Clean | None | None | Low |
| webapp/platform/compass-icons/components/checkbox-blank-outline.d.ts | Clean | None | None | Low |

## Remediations

### [SEC-SSRF-01] SSRF in File Download Service
- **File:** `server/channels/app/download.go`
- **Severity:** Critical
- **Description:** The download service was using a client that allowed untrusted internal connections, exposing the server to SSRF attacks against internal metadata services or databases.

**Before:**
```go
a.HTTPService().MakeClient(true).Get(url)
```

**After:**
```go
a.HTTPService().MakeClient(false).Get(url)
```
...
- **Severity:** Critical
- **Description:** The OAuth discovery logic allowed requests to internal network ranges via MakeClient(true).

**Before:**
```go
a.HTTPService().MakeClient(true).Do(req)
```

**After:**
```go
a.HTTPService().MakeClient(false).Do(req)
```

---

### [SEC-SQLI-01] SQL Injection in Attributes Store Search
- **File:** `server/channels/store/sqlstore/attributes_store.go`
- **Severity:** High
- **Description:** Manual string numbering ($1, $2) and fmt.Sprintf were used to build complex subqueries, which is prone to errors and injection if not handled perfectly.

**Before:**
```go
sq.Expr(fmt.Sprintf("Users.Id IN (... WHERE TeamId = $%d ...)", argCount), opts.TeamID)
```

**After:**
```go
query.Where("Users.Id IN (... WHERE TeamId = ? ...)", opts.TeamID)
```

---

### [SEC-SQLI-02] SQL Injection in Post Store Filter
- **File:** `server/channels/store/sqlstore/post_store.go`
- **Severity:** High
- **Description:** Post type filtering used fmt.Sprintf to inject the prefix directly into the query string.
...
### [SEC-SQLI-03] SQL Injection in Team Store Search
- **File:** `server/channels/store/sqlstore/team_store.go`
- **Severity:** High
- **Description:** Team name and display name search used string formatting instead of parameter binding.

**Before:**
```go
Where(fmt.Sprintf("(Name %[1]s '%[2]s' OR DisplayName %[1]s '%[2]s')", operatorKeyword, term))
```
