...
// The plugin package is used by Sofa server plugins written in go. It also enables the
// Sofa server to manage and interact with the running plugin environment.
//
