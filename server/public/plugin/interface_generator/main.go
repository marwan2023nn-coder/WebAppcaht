...
var hooksTemplate = `// Copyright (c) 2015-present Sofa, Inc. All Rights Reserved.
// See LICENSE.txt for license information.
...
var apiTimerLayerTemplate = `// Copyright (c) 2015-present Sofa, Inc. All Rights Reserved.
// See LICENSE.txt for license information.
...
var hooksTimerLayerTemplate = `// Copyright (c) 2015-present Sofa, Inc. All Rights Reserved.
// See LICENSE.txt for license information.
...
func getPluginPackageDir() string {
	dirs, err := goList("github.com/marwan2023nn-coder/sofa/server/public/plugin")
	if err != nil {
		panic(err)
	} else if len(dirs) != 1 {
