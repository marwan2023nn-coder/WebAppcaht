...
type TeamStore interface {
	...
	GetAdminTeamIdsForUser(userID string, allowFromCache bool) ([]string, error)
}
...
type UserStore interface {
	...
	SoftDelete(rctx request.CTX, userID string) error
	...
	DeactivateInactiveUsers(threshold int64) (int64, error)
...
type FileInfoStore interface {
	...
	GetForPosts(postIDs []string, readFromMaster, includeDeleted, allowFromCache bool) ([]*model.FileInfo, error)
	...
	CountAttached() (int64, error)
	CountDownloaded() (int64, error)
...
type GroupStore interface {
	...
	GroupCount(opts model.GroupSearchOpts, viewRestrictions *model.ViewUsersRestrictions) (int64, error)
