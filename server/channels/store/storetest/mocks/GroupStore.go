...
// GroupCount provides a mock function with given fields: opts, viewRestrictions
func (_m *GroupStore) GroupCount(opts model.GroupSearchOpts, viewRestrictions *model.ViewUsersRestrictions) (int64, error) {
	ret := _m.Called(opts, viewRestrictions)
	...
	var r0 int64
	var r1 error
	if rf, ok := ret.Get(0).(func(model.GroupSearchOpts, *model.ViewUsersRestrictions) (int64, error)); ok {
		return rf(opts, viewRestrictions)
	}
	if rf, ok := ret.Get(0).(func(model.GroupSearchOpts, *model.ViewUsersRestrictions) int64); ok {
		r0 = rf(opts, viewRestrictions)
	} else {
		r0 = ret.Get(0).(int64)
	}

	if rf, ok := ret.Get(1).(func(model.GroupSearchOpts, *model.ViewUsersRestrictions) error); ok {
		r1 = rf(opts, viewRestrictions)
	} else {
		r1 = ret.Error(1)
	}
