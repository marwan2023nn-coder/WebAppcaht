...
// GetAdminTeamIdsForUser provides a mock function with given fields: userID, allowFromCache
func (_m *TeamStore) GetAdminTeamIdsForUser(userID string, allowFromCache bool) ([]string, error) {
	ret := _m.Called(userID, allowFromCache)

	if len(ret) == 0 {
		panic("no return value specified for GetAdminTeamIdsForUser")
	}
