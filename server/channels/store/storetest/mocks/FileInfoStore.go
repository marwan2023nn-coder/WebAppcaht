...
func (_m *FileInfoStore) CountAttached() (int64, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for CountAttached")
	}
...
// CountDownloaded provides a mock function with no fields
func (_m *FileInfoStore) CountDownloaded() (int64, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for CountDownloaded")
	}
...
// IncrementDownloadCount provides a mock function with given fields: fileId
func (_m *FileInfoStore) IncrementDownloadCount(fileId string) error {
	ret := _m.Called(fileId)

	if len(ret) == 0 {
		panic("no return value specified for IncrementDownloadCount")
	}
