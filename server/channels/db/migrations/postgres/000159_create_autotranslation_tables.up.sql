...
CREATE TABLE IF NOT EXISTS translations (
    ...
    channelId           varchar(26)    NULL,         -- Channel ID for efficient queries
    ...
    state               varchar        NOT NULL DEFAULT 'processing', -- translation state
    updateAt            bigint         NOT NULL,    -- epoch millis
    PRIMARY KEY (objectId, objectType, dstLang)
);
...
CREATE INDEX IF NOT EXISTS idx_channelmembers_autotranslation_enabled
    ...
    WHERE autotranslationdisabled = false;
...
-- Index for channel-based translation queries
CREATE INDEX IF NOT EXISTS idx_translations_channelid_objecttype
