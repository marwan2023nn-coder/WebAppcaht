...
import (
	...
	email "github.com/marwan2023nn-coder/sofa/server/v8/channels/app/email"
...
func (a *App) buildEmailNotification(
	...
	if license := a.Srv().License(); license != nil && license.Features != nil && *license.Features.EmailNotificationContents {
