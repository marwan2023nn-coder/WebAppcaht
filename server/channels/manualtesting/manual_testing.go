...
import (
	...
	"github.com/marwan2023nn-coder/sofa/server/v8/channels/app/slashcommands"
...
func ManualTest(c *web.Context, w http.ResponseWriter, r *http.Request) {
	...
	if ok1 && ok2 {
		...
		channel := &model.Channel{DisplayName: "المجموعة الرئيسية", Name: "town-square", Type: model.ChannelTypeOpen, TeamId: createdTeam.Id}
