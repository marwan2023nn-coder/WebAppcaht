...
Link 3 example: https://github.com/sofa

Link 4 example: http://stackoverflow.com/questions/36650437/using-sofa-api-via-gitlab-oauth-as-an-end-user-with-username-and-password
```
