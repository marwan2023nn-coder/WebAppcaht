...
func (s *MmctlE2ETestSuite) TestPluginInstallURLCmd() {
	...
	const (
		jiraURL        = "https://plugins.releases.sofa.com/release/sofa-plugin-jira-v3.0.0.tar.gz"
		jiraPluginID   = "jira"
		githubURL      = "https://plugins.releases.sofa.com/release/sofa-plugin-github-v2.0.0.tar.gz"
	...
	s.RunForSystemAdminAndLocal("install a nonexistent plugin", func(c client.Client) {
		...
		const pluginURL = "https://plugins.releases.sofa.com/release/sofa-nonexistent-plugin-v2.0.0.tar.gz"
		var expected error
