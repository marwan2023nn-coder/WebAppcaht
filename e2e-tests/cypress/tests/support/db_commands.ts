...
const message = `Compare "cypress.json" against "config.json" of sofa-server. It should match database driver and connection string.

The value at "cypress.json" is based on default sofa-server's local database:
