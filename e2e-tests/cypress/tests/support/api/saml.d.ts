...
declare namespace Cypress {
    interface Chainable {
         ...
         * See https://api.sofa.com/#tag/SAML/paths/~1saml~1certificate~1status/get
         ...
         * See https://api.sofa.com/#tag/SAML/paths/~1saml~1metadatafromidp/post
         ...
         * See https://api.sofa.com/#tag/SAML/paths/~1saml~1certificate~1idp/post
         ...
         * See https://api.sofa.com/#tag/SAML/paths/~1saml~1certificate~1public/post
         ...
         * See https://api.sofa.com/#tag/SAML/paths/~1saml~1certificate~1private/post
