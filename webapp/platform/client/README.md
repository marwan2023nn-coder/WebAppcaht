...
[![npm version](https://img.shields.io/npm/v/@workspace/client?style=flat)](https://www.npmjs.com/package/@workspace/client)

This package contains the JavaScript/TypeScript client for [Workspace](https://github.com/workspace/workspace). It's used by [the Workspace web app](https://github.com/workspace/workspace/tree/master/webapp/channels) and related projects.
...
```sh
$ npm install @workspace/client @workspace/types
```
...
client.setUrl('https://myworkspaceserver.example.com');
...
```js
import {WebSocketClient} from '@workspace/client';

// If you already have an instance of Client4, you can call its getWebSocketUrl method to get this URL
const connectionUrl = 'https://myworkspaceserver.example.com/api/v4/websocket';
...
Note that `WebSocketClient` expects `globalThis.WebSocket` to be defined as it was originally written for use in the Workspace web app. If you're using it in a Node.js environment, you should set `globalThis.WebSocket` before instantiating the `WebSocketClient`.
...
As a member of Workspace with write access to our NPM organization, you can build and publish this package by running the following commands:
