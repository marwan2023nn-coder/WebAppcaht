# @workspace/eslint-plugin

An ESLint plugin containing the configuration used by Workspace as well as support for custom rules specific to the Workspace code base.
...
Ensures that any link which opens a URL outside of Workspace using `target="_blank"` uses the `ExternalLink` component.
