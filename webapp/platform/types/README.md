...
This package contains shared type definitions used by [the Workspace web app](https://github.com/workspace/workspace-webapp) and related projects.
...
{
    "moduleNameMapper": {
        "^@workspace/types/(.*)$": "<rootDir>/node_modules/@workspace/types/lib/$1"
    }
}
```
