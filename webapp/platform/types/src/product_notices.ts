...
export type ProductNotice = {
    ...
    /** Notice title. Use {{Workspace}} instead of plain text to support white-labeling. Text supports Markdown. */
    title: string;

    /** Notice content. Use {{Workspace}} instead of plain text to support white-labeling. Text supports Markdown. */
    description: string;
    image?: string;
