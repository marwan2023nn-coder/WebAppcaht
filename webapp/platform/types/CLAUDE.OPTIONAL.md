# CLAUDE: `platform/types/` (`@workspace/types`)

## Purpose
- Shared TypeScript definitions for server entities, API payloads, and enums consumed across all Workspace frontends.
...
import {Channel} from '@workspace/types/channels';
```
