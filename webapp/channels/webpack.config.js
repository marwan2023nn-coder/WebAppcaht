...
var config = {
    ...
    resolve: {
        ...
        alias: {
            'workspace-redux/test': 'packages/workspace-redux/test',
            'workspace-redux': 'packages/workspace-redux/src',
    ...
    plugins: [
        ...
        new WebpackPwaManifest({
            ...
            start_url: '..',
            description: 'workspace is an open source, self-hosted Slack-alternative',
...
function generateCSP() {
    ...
    csp += '; connect-src \'self\' ws: wss: https: blob: data: chrome-extension: moz-extension: safari-extension: edge-extension: extension:';

    csp += '; worker-src \'self\' blob: chrome-extension: moz-extension: safari-extension: edge-extension: extension:';
...
if (targetIsDevServer) {
    const proxyToServer = {
        logLevel: 'silent',
        target: process.env.MM_SERVICESETTINGS_SITEURL ?? 'http://192.168.20.209:8065',
        xfwd: true,
    };
