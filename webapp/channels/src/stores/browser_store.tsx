...
class BrowserStoreClass {
    ...
    setLandingPreferenceToWorkspaceApp(siteUrl?: string) {
        localStorage.setItem(StoragePrefixes.LANDING_PREFERENCE + String(siteUrl), LandingPreferenceTypes.WorkspaceAPP);
    }
