...
import * as GeneralSelectors from 'workspace-redux/selectors/entities/general';
import * as PreferenceSelectors from 'workspace-redux/selectors/entities/preferences';
...
jest.mock('workspace-redux/selectors/entities/users', () => {
    const originalModule = jest.requireActual('workspace-redux/selectors/entities/users');
    return {
        ...originalModule,
