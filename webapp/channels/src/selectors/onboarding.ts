...
import {get as getString, getBool, makeGetCategory} from 'workspace-redux/selectors/entities/preferences';
import {getCurrentUser, isFirstAdmin} from 'workspace-redux/selectors/entities/users';
