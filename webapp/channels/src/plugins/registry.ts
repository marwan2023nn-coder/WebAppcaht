...
import reducerRegistry from 'workspace-redux/store/reducer_registry';
...
export default class PluginRegistry {
    ...
    registerPostDropdownMenuComponent = reArg(['component'], ({component}: DPluginComponentProp) => {
        if (!this.warnedAboutRegisterPostDropdownMenuComponent) {
            // eslint-disable-next-line no-console
            // console.warn(
            //     `${this.id}: This plugin is using registerPostDropdownMenuComponent which is deprecated in Workspace ` +
            ...
            //     'https://forum.workspace.com/t/deprecating-a-post-dropdown-menu-component-plugin-api-v11/25001 for ' +
            //     'more information.',
            // );
