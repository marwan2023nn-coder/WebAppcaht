...
import type {AppForm, AppCallRequest} from '@workspace/types/apps';
import type {DialogElement, DialogSubmission, SubmitDialogResponse} from '@workspace/types/integrations';
