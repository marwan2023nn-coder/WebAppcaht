...
import type {FileSearchResultItem} from '@workspace/types/files';
import type {Post} from '@workspace/types/posts';

import {getSearchFilesResults} from 'workspace-redux/selectors/entities/files';
import {getSearchMatches, getSearchResults} from 'workspace-redux/selectors/entities/posts';
import {getCurrentTeam} from 'workspace-redux/selectors/entities/teams';
import {makeAddDateSeparatorsForSearchResults} from 'workspace-redux/utils/post_list';
