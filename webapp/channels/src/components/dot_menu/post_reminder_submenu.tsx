...
import {ChevronRightIcon, ClockOutlineIcon} from '@workspace/compass-icons/components';
import type {Post} from '@workspace/types/posts';

import {addPostReminder} from 'workspace-redux/actions/posts';
...
function PostReminderSubmenu(props: Props) {
    ...
    return (
        <Menu.SubMenu
            ...
            trailingElements={<span className={'dot-menu__item-trailing-icon'}><ChevronRightIcon size={16} className='chevron-right' /></span>}
