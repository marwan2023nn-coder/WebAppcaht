...
import {isSystemMessage} from 'workspace-redux/utils/post_utils';
...
function mapDispatchToProps(dispatch: Dispatch) {
    return {
        actions: {
            ...
            setFocusPost: (post: Post, targetChannelId?: string) => dispatch({type: 'SET_FOCUS_POST', post, targetChannelId}),
        },
    };
}
