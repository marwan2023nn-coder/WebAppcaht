...
jest.mock('workspace-redux/selectors/entities/roles', () => ({
...
jest.mock('workspace-redux/utils/user_utils', () => {
    const original = jest.requireActual('workspace-redux/utils/user_utils');
    return {
        ...original,
...
jest.mock('workspace-redux/selectors/entities/channels', () => ({
    ...jest.requireActual('workspace-redux/selectors/entities/channels') as typeof import('workspace-redux/selectors/entities/channels'),
    getChannelMember: jest.fn(() => mockChannelMember),
}));

jest.mock('workspace-redux/selectors/entities/common', () => {
    return {
        ...jest.requireActual('workspace-redux/selectors/entities/common') as typeof import('workspace-redux/selectors/entities/users'),
...
describe('ChannelSettingsInfoTab', () => {
    ...
    it('should call patchChannel with updated values when Save is clicked (non-privacy changes)', async () => {
        const {patchChannel} = require('workspace-redux/actions/channels');
    ...
    it('should convert channel when confirming in ConvertConfirmModal', async () => {
        ...
        const {updateChannelPrivacy} = require('workspace-redux/actions/channels');
