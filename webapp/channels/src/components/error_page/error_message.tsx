            ...
            errorMessage = (
                <div>
                    <FormattedMessage
                        ...
                        defaultMessage='Workspace was unable to load because a setting in your browser prevents the use of its local storage features. To allow Workspace to load, try the following actions:'
                    />
                    <ul>
                        <li>
                            <FormattedMessage
                ...
                <div>
                    ...
                    <p>
                        <FormattedMessage
                            ...
                            values={{
                                link: (
                                    <ErrorLink
                                        url={'https://docs.workspace.com/deployment/sso-google.html'}
                    ...
                    <p>
                        <FormattedMessage
                            ...
                            defaultMessage='For {link} make sure the administrator of your Microsoft organization has enabled the Workspace app.'
                            values={{
                                link: (
                                    <ErrorLink
                                        url={'https://docs.workspace.com/deployment/sso-office.html'}
                                        message={defineMessage({
                    ...
                    <p>
                        <FormattedMessage
                            ...
                            values={{
                                link: (
                                    <ErrorLink
                                        url={'https://docs.workspace.com/deployment/sso-gitlab.html'}
                                        message={defineMessage({
                    ...
                    <p>
                        <FormattedMessage
                            ...
                            values={{
                                link: (
                                    <ErrorLink
                                        url={'https://forum.workspace.com/c/trouble-shoot'}
                                        message={defineMessage({
            ...
            errorMessage = (
                <p>
                    <FormattedMessage
                        ...
                        defaultMessage='You must authorize Workspace to log in with {service}.'
                        values={{
                            service,
                        }}
                    />
