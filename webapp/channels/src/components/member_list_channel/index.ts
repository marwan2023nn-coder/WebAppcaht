...
import {getChannelStats, getChannelMembers} from 'workspace-redux/actions/channels';
...
import {getMembersInCurrentChannel, getCurrentChannelStats, getCurrentChannel} from 'workspace-redux/selectors/entities/channels';
import {getMembersInCurrentTeam} from 'workspace-redux/selectors/entities/teams';
import {searchProfilesInCurrentChannel, getProfilesInCurrentChannel} from 'workspace-redux/selectors/entities/users';
