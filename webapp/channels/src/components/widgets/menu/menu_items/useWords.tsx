...
import {WorkspaceFeatures, LicenseSkus} from 'utils/constants';
...
export default function useWords(highestLimit: LimitSummary | false, isAdminUser: boolean): Words | false {
    ...
    case LimitTypes.messageHistory:
        featureToNotifyOn = WorkspaceFeatures.UNLIMITED_MESSAGES;
        break;
    case LimitTypes.fileStorage:
        featureToNotifyOn = WorkspaceFeatures.UNLIMITED_FILE_STORAGE;
        break;
    default:
        break;
    }
