...
import type {UserThread, UserThreadSynthetic} from '@workspace/types/threads';
...
import {getPost, makeGetPostsForThread} from 'workspace-redux/selectors/entities/posts';
