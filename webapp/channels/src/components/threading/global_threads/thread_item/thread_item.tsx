...
import {DotsVerticalIcon} from '@workspace/compass-icons/components';
...
import {markLastPostInThreadAsUnread, updateThreadRead} from 'workspace-redux/actions/threads';
