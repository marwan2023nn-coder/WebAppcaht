            ...
            <div className='Help__content'>
                ...
                <section className='Help__section'>
                    ...
                    <table className='Help__table'>
                        ...
                        <tbody>
                            <tr>
                                <td><code>{'[Check out Sofa Workspace!](https://workspace.com/)'}</code></td>
                                <td><a href='https://workspace.com/'>{'Check out Sofa Workspace!'}</a></td>
                            </tr>
                        </tbody>
                    </table>
                </section>
                ...
                <section className='Help__section'>
                        ...
                        <FormattedMessage
                            ...
                            values={{
                                ...
                                link: (chunks: React.ReactNode) => (
                                    <ExternalLink
                                        href='https://docs.workspace.com/end-user-guide/collaborate/format-messages.html'
                    ...
                    <table className='Help__table'>
                        ...
                        <tbody>
                            <tr>
                                <td><code>{'![Sofa Workspace Logo](/static/images/logo_email_dark.png)'}</code></td>
                                <td>
                                    <img
                                        src='/static/images/logo_email_dark.png'
                                        alt='Sofa Workspace Logo'
