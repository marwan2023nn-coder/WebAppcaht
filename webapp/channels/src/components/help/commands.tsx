            ...
            <div className='Help__content'>
                <p>
                    <FormattedMessage
                        ...
                        defaultMessage='You can execute commands, called slash commands, by typing into the text input box to perform operations in Sofa Workspace. To run a slash command, type <code>/</code> followed by a command and some arguments to perform actions.'
                        values={{
                ...
                <section className='Help__section'>
                    ...
                    <p>
                        <FormattedMessage
                            ...
                            defaultMessage='Built-in slash commands come with all Sofa Workspace installations. See the <link>product documentation</link> for a list of available built-in slash commands.'
                            values={{
                                link: (chunks: React.ReactNode) => (
                                    <ExternalLink
                                        href='https://docs.workspace.com/integrations-guide/built-in-slash-commands.html'
                    ...
                    <p>
                        <FormattedMessage
                            ...
                            values={{
                                ...
                                link: (chunks: React.ReactNode) => (
                                    <ExternalLink
                                        href='https://developers.workspace.com/integrate/slash-commands/custom/'
                                        location='help_commands'
                                    >
                                        {chunks}
                                    </ExternalLink>
