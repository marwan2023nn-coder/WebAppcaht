                ...
                <section className='Help__section'>
                    ...
                    <p>
                        <FormattedMessage
                            ...
                            defaultMessage='Use the text input box at the bottom of the Sofa Workspace interface to write a message. Press <b>ENTER</b> to send the message. Use <b>SHIFT+ENTER</b> to create a new line without sending a message.'
                            values={{
                ...
                <section className='Help__section'>
                    ...
                    <table className='Help__table'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><code>{'[hyperlink](https://www.workspace.com)'}</code></td>
                                <td><a href='https://www.workspace.com'>{'hyperlink'}</a></td>
                            </tr>
                            <tr>
                                <td><code>{'![embedded image](travis-ci.org/workspace/platform.svg)'}</code></td>
                                <td>
                        ...
                        <FormattedMessage
                            ...
                            values={{
                                ...
                                link: (chunks: React.ReactNode) => (
                                    <ExternalLink
                                        href='https://docs.workspace.com/end-user-guide/collaborate/react-with-emojis-gifs.html#upload-custom-emojis'
                ...
                <section className='Help__section'>
                    ...
                    <p>
                        <FormattedMessage
                            ...
                            defaultMessage='Drag and drop files into Sofa Workspace, or select the Attachment icon in the text input box.'
                        />
                    </p>
                </section>
