...
import {isCurrentLicenseCloud, getSubscriptionProduct as selectSubscriptionProduct} from 'workspace-redux/selectors/entities/cloud';
import {get as selectPreference} from 'workspace-redux/selectors/entities/preferences';
import {getCurrentUser, isCurrentUserSystemAdmin} from 'workspace-redux/selectors/entities/users';
...
import {CloudProducts, LicenseSkus, WorkspaceFeatures, Preferences} from 'utils/constants';
                    ...
                    a: (chunks: React.ReactNode) => (
                        <NotifyAdminCTA
                            ...
                            notifyRequestData={{
                                ...
                                required_feature: WorkspaceFeatures.UNLIMITED_FILE_STORAGE,
