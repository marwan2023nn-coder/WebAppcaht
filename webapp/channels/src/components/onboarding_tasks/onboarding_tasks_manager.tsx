...
import {isCurrentUserGuestUser, isCurrentUserSystemAdmin, isFirstAdmin} from 'workspace-redux/selectors/entities/users';
...
export const useHandleOnBoardingTaskTrigger = () => {
    ...
    return (taskName: string) => {
        ...
        //     }];
        //     dispatch(savePreferences(currentUserId, preferences));
        //     window.open('https://workspace.com/download#desktop', '_blank', 'noopener,noreferrer');
        //     break;
        // }
