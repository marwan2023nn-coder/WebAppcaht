...
import {cleanUpStatusAndProfileFetchingPoll} from 'workspace-redux/actions/status_profile_polling';
...
import SidebarDirectMessages from 'components/sidebar/sidebar_direct_messages';
...
export default function ChannelController(props: Props) {
    ...
    const toggleDirectMessagesSidebar = () => {
    ...
    return (
        <>
            ...
            <Sidebar
                toggleDirectMessagesSidebar={toggleDirectMessagesSidebar}
                showDirectMessages={showDirectMessages}
            />
            {showDirectMessages && <SidebarDirectMessages/>}
            <div
                id='channel_view'
