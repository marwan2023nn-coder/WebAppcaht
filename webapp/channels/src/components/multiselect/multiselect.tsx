        ...
        return (
            <>
                <div className='filtered-user-list'>
                        ...
                        >
                            <ReactSelect
                                ...
                                components={{
                                    ...
                                    MultiValueLabel: this.props.valueWithImage ? components.MultiValueLabel : PaddedMultiValueLabel,
                    ...
                    {this.props.saveButtonPosition === 'top' && this.props.showPaginationControls !== false &&
...
const getUserLabel = (data: any): string => {
    if (!data) {
        return '';
    }
...
const PaddedMultiValueLabel = (props: any) => {
    return (
