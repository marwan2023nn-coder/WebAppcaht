...
const WorkspaceUserGuideLink = 'https://docs.workspace.com/guides/use-workspace.html';
const trainingResourcesLink = 'https://academy.workspace.com/';
const askTheCommunityUrl = 'https://workspace.com/pl/default-ask-workspace-community/';
        ...
        return (
            <Menu.Group>
                <Menu.ItemExternalLink
                    id='WorkspaceUserGuideLink'
                    iconClassName='icon-file-text-outline'
                    url={WorkspaceUserGuideLink}
                    text={intl.formatMessage({id: 'userGuideHelp.workspaceUserGuide', defaultMessage: 'Workspace user guide'})}
                />
                {/* {this.props.helpLink && (
                    <Menu.ItemExternalLink
