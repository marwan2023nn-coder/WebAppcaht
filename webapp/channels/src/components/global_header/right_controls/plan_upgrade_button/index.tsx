...
import {getCloudProducts, getCloudSubscription} from 'workspace-redux/actions/cloud';
import {getCloudSubscription as selectCloudSubscription, getSubscriptionProduct as selectSubscriptionProduct, isCurrentLicenseCloud} from 'workspace-redux/selectors/entities/cloud';
