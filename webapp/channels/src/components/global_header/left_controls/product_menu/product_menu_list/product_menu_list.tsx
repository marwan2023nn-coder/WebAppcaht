...
import {LicenseSkus, ModalIdentifiers, WorkspaceFeatures} from 'utils/constants';
        ...
        <Menu.Group>
            <div onClick={onClick}>
                ...
                <Menu.ItemToggleModalRedux
                    id='userGroups'
                    modalId={ModalIdentifiers.USER_GROUPS}
                    show={isAdmin && (enableCustomUserGroups || isStarterFree || isFreeTrial)}
                    dialogType={UserGroupsModal}
                    dialogProps={{
                        backButtonAction: openGroupsModal,
                    }}
                    ...
                    sibling={(isAdmin && (isStarterFree || isFreeTrial)) && (
                        <RestrictedIndicator
                            ...
                            feature={WorkspaceFeatures.CUSTOM_USER_GROUPS}
