...
} from 'workspace-redux/selectors/entities/general';
import {
    getInt,
    isCustomGroupsEnabled,
} from 'workspace-redux/selectors/entities/preferences';
import {haveICurrentTeamPermission, haveISystemPermission} from 'workspace-redux/selectors/entities/roles';
...
function mapStateToProps(state: GlobalState) {
    ...
    const siteName = config.SiteName || 'Workspace';
