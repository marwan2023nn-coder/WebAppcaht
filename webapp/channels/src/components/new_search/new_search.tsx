...
import {getCurrentChannelNameForSearchShortcut} from 'workspace-redux/selectors/entities/channels';
import {getIsCrossTeamSearchEnabled} from 'workspace-redux/selectors/entities/general';
                    ...
                    <FloatingFocusManager context={floatingContext}>
                        ...
                        >
                            <SearchBox
                                ...
                                onSearch={runSearch}
                                initialSearchTerms={currentChannel ? `${locale?.startsWith('ar') ? 'في:' : 'in:'}${currentChannel} ` : searchTerms}
