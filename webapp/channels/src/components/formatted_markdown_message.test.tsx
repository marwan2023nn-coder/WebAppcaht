...
describe('components/FormattedMarkdownMessage', () => {
    test('should render message', () => {
        const props = {
            id: 'test.foo',
            defaultMessage: '**bold** *italic* [link](https://workspace.com/) <br/> [link target blank](!https://workspace.com/)',
        };
    ...
    test('should allow to disable links', () => {
        const props = {
            ...
            defaultMessage: '*Hi* {petName}!',
            values: {
                petName: 'http://www.workspace.com',
            },
            disableLinks: true,
        };
        const wrapper = mount(wrapProvider(<FormattedMarkdownMessage {...props}/>));
...
export function wrapProvider(el: JSX.Element) {
    const enTranslationData = {
        'test.foo': '**bold** *italic* [link](https://workspace.com/) <br/> [link target blank](!https://workspace.com/)',
