...
import type {OpenGraphMetadata, Post} from '@workspace/types/posts';
...
const openGraphData = {
    description: 'Workspace is a secure, open source platform for communication, collaboration, and workflow orchestration across tools and teams.',
    images: [{
        height: 1256,
        ...
        url: '',
        width: 2400}],
    site_name: 'Workspace.com',
    title: 'Workspace | Open Source Collaboration for Developers',
    type: 'website',
    url: 'https://www.workspace.com',
};
...
describe('PostAttachmentOpenGraph', () => {
    const imageUrl = 'http://workspace.com/OpenGraphImage.jpg';
    ...
    const baseProps = {
        ...
        openGraphData: {
            ...
            site_name: 'Workspace',
            title: 'Workspace Private Cloud Messaging',
        },
