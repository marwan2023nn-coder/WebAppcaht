...
jest.mock('workspace-redux/utils/post_utils', () => {
    const actual = jest.requireActual('workspace-redux/utils/post_utils');
    return {
        ...actual,
...
describe('PostBodyAdditionalContent', () => {
    ...
    describe('with a permalinklink', () => {
        const permalinkUrl = 'https://community.workspace.com/core/pl/123456789';
