...
import {getTotalUsersStats} from 'workspace-redux/actions/users';
import {getCurrentChannel, getDirectTeammate, getMyCurrentChannelMembership, isCurrentChannelFavorite} from 'workspace-redux/selectors/entities/channels';
...
import {getCurrentUser, getProfilesInCurrentChannel, getCurrentUserId, getUser, getTotalUsersStats as getTotalUsersStatsSelector} from 'workspace-redux/selectors/entities/users';
