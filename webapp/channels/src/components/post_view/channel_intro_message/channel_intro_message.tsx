...
import {BellRingOutlineIcon, GlobeIcon, PencilOutlineIcon, StarOutlineIcon, LockOutlineIcon, StarIcon} from '@workspace/compass-icons/components';
...
import {NotificationLevel} from 'workspace-redux/constants/channels';
