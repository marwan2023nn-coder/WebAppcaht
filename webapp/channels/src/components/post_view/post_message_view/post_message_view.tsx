...
export default class PostMessageView extends React.PureComponent<Props, State> {
    ...
    render() {
        ...
        if (!enableFormatting) {
            if (post.message === 'BUZZMESSAGE') {
                return <BuzzSvg width={90}height={90}/>;
            }
        ...
        const isBuzzMessage = message === 'BUZZMESSAGE';
        ...
        const showMoreText = isBuzzMessage ? '' : message;
