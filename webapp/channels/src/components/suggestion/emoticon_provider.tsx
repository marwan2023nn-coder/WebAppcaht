...
import {autocompleteCustomEmojis} from 'workspace-redux/actions/emojis';
import {getEmojiImageUrl, isSystemEmoji} from 'workspace-redux/utils/emoji_utils';
...
export default class EmoticonProvider extends Provider {
    ...
    // See https://workspace.atlassian.net/browse/MM-17320.
