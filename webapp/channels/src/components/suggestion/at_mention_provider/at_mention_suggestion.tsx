...
const AtMentionSuggestion = React.forwardRef<HTMLLIElement, SuggestionProps<Item>>((props, ref) => {
    ...
    let visibleMainText: string | undefined;
    ...
    if (item.username === 'all') {
        ...
        const hasDisplayName = Boolean(fullName || nickname);
        visibleMainText = hasDisplayName ? (fullName || nickname) : `@${itemname}`;
        ...
        if (item.isCurrentUser) {
            ...
            description = <span>{`(${nickname})`}</span>;
        }
