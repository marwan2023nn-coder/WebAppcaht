...
describe('at mention suggestion', () => {
    ...
    test('should not display nick name of the signed in user', () => {
        ...
        expect(wrapper.find('.suggestion-list__ellipsis').text()).not.toContain('@user');
    ...
    test('should display nick name of non signed in user', () => {
        ...
        expect(wrapper.find('.suggestion-list__ellipsis').text()).toContain('a b');
        expect(wrapper.find('.suggestion-list__ellipsis').text()).toContain('(c)');
        expect(wrapper.find('.suggestion-list__ellipsis').text()).not.toContain('@user2');
    });
