...
import {getChannelNameForSearchShortcut} from 'workspace-redux/selectors/entities/channels';
import {isDirectChannel, isGroupChannel, sortChannelsByTypeListAndDisplayName} from 'workspace-redux/utils/channel_utils';
