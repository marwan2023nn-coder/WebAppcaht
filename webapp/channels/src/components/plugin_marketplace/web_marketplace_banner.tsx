...
import {ArrowRightIcon} from '@workspace/compass-icons/components';
...
const WEB_MARKETPLACE_LINK = 'https://workspace.com/marketplace';
    ...
    return (
        <WebMarketplaceBannerRoot className='WebMarketplaceBanner'>
            ...
            >
                ...
                <Description>
                    {formatMessage({id: 'marketplace_modal.web_marketplace_link.desc', defaultMessage: 'Connect the tools you use most to Workspace'})}
                </Description>
                <IconsContainer>
