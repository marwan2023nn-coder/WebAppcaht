...
// import {AnalyticsRow} from '@workspace/types/admin';
...
// // @see discussion here: https://github.com/workspace/workspace-webapp/pull/9822#discussion_r806879385
...
//         }),
//         ...options.trialOrEnterpriseCtaConfig,
//         infoUrl: 'https://docs.workspace.com/onboard/guest-accounts.html',
//         infoText: formatMessage({id: 'admin.reporting.workspace_optimization.cta.learnMore', defaultMessage: 'Learn more'}),
