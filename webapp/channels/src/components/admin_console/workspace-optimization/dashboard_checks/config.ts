...
const ssl = (
    ...
    return {
        ...
        description: formatMessage({
            ...
            defaultMessage: 'We strongly recommend securing your Workspace workspace by configuring SSL in production environments.',
        }),
...
/**
 *
 * @description This checks to see if Workspace is running as root.
 */
const rootUserCheck = async (
    ...
    return {
        ...
        title: formatMessage({
            ...
            defaultMessage: 'Workspace is running as root',
        }),
        description: formatMessage({
            id: 'admin.reporting.workspace_optimization.configuration.root_status.description',
            defaultMessage: 'Running Workspace as root is not recommended. Please use a non-root user.',
        }),
...
const fileStorage = async (
    ...
    return {
        ...
        description: formatMessage({
            ...
            defaultMessage: 'Check your file storage settings to ensure your Workspace workspace has access to the configured file storage.',
        }),
