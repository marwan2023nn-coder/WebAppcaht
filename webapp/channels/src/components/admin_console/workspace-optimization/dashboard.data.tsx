...
import {getLicense, getServerVersion} from 'workspace-redux/selectors/entities/general';
...
const getAccessData = async (
    ...
    description: formatMessage({
        ...
        defaultMessage: 'Web server configuration may be affecting access to your Workspace workspace.',
    }),
    hide: options.isCloud,
    descriptionOk: formatMessage({
...
const getEaseOfManagementData = async (
    ...
    description: formatMessage({
        ...
        defaultMessage: 'Make it easier to manage your Workspace workspace.',
    }),
    descriptionOk: formatMessage({
