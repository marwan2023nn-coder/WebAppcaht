...
import type {ExperimentalSettings, PluginSettings, SSOSettings, Office365Settings} from '@workspace/types/config';
...
describe('components/AdminSidebar', () => {
    ...
    describe('generateIndex', () => {
        const props: Props = {
            ...
            subscriptionProduct: undefined,
            plugins: {
                'workspace-autolink': samplePlugin1,
            },
            onSearchChange: jest.fn(),
            actions: {
                getPlugins: jest.fn(),
    ...
    describe('Plugins', () => {
        ...
        test('should filter plugins', () => {
            ...
            idx.search.mockReturnValue(['plugin_Workspace-autolink']);
            wrapper.find('#adminSidebarFilter').simulate('change', {target: {value: 'autolink'}});

            expect((wrapper.instance().state as any).sections).toEqual(['plugin_Workspace-autolink']);
            expect(wrapper).toMatchSnapshot();
            ...
            expect(autoLinkPluginSection.prop('name')).toBe('plugins/plugin_Workspace-autolink');
        });
    });
});
