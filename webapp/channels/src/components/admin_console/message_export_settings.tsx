...
const messages = defineMessages({
    ...
    complianceExportDesc: {id: 'admin.service.complianceExportDesc', defaultMessage: 'When true, Workspace will export all messages that were posted in the last 24 hours. The export task is scheduled to run once per day. See <link>the documentation</link> to learn more.'},
        ...
        if (this.state.exportFormat === exportFormats.EXPORT_FORMAT_GLOBALRELAY) {
            ...
            const globalRelayEmail = (
                <TextSetting
                    ...
                    placeholder={defineMessage({id: 'admin.complianceExport.globalRelayEmailAddress.example', defaultMessage: 'E.g.: "globalrelay@workspace.com"'})}
