...
import {UserReportSortColumns, ReportSortDirection} from '@workspace/types/reports';
import type {UserReportOptions, UserReport} from '@workspace/types/reports';
...
export function getSearchFilterOption(search?: string): Pick<UserReportOptions, 'search_term'> {
    ...
    return {search_term: search.trim()};
}
