...
import type {Job, JobType} from '@workspace/types/jobs';
...
export const messages = defineMessages({
    ...
    skipTLSVerificationDescription: {id: 'admin.elasticsearch.skipTLSVerificationDescription', defaultMessage: 'When true, Workspace will not require the Elasticsearch certificate to be signed by a trusted Certificate Authority.'},
    ...
    testHelpText: {id: 'admin.elasticsearch.testHelpText', defaultMessage: 'Tests if the Workspace server can connect to the Elasticsearch server specified. Testing the connection only saves the configuration if the test is successful. A successful test will also re-initialize the client if you have started Elasticsearch after starting Workspace. But this will not restart the workers. To do that, please toggle "Enable Elasticsearch Indexing".'},
...
export const searchableStrings: Array<string|MessageDescriptor|[MessageDescriptor, {[key: string]: any}]> = [
    [messages.connectionUrlDescription, {link: ''}],
    [messages.enableIndexingDescription, {link: ''}],
    messages.title,
