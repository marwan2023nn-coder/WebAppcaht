...
import type {TestLdapFiltersResponse} from '@workspace/types/admin';
    ...
    const renderSidebar = () => {
        return (
            <div className='ldap-wizard-sidebar'>
                ...
                {memoizedSections.map((section: LDAPAdminDefinitionConfigSchemaSection) => (
                    <button
                    ...
                    >
                        {section.sectionTitle ? section.sectionTitle : (section.title ? <SchemaText text={section.title}/> : null)}
                    </button>
                ))}
            </div>
        );
        ...
        const renderedSections = memoizedSections.map((section) => {
            ...
            return (
                ...
                >
                    <SettingsGroup
                        show={true}
                        title={section.title ? <SchemaText text={section.title}/> : null}
                        subtitle={section.subtitle ? <SchemaText text={section.subtitle}/> : null}
                    >
