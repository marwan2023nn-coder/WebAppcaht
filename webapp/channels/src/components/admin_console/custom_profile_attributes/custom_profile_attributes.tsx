...
import type {UserPropertyField, UserPropertyFieldType} from '@workspace/types/properties';
    ...
    <div className='help-text-container'>
        {attributeKey === 'ldap' && (
            <FormattedMessage
                ...
                defaultMessage='(Optional) The attribute in the AD/LDAP server used to populate the {name} of users in Workspace. When set, users cannot edit their {name}, since it is synchronized with the LDAP server. When left blank, users can set their {name} in <strong>Account Menu > Account Settings > Profile</strong>.'
                values={{
                    name: attributeName,
        ...
        {attributeKey === 'saml' && (
            <FormattedMessage
                id='admin.customProfileAttribDesc'
                defaultMessage='(Optional) The attribute in the SAML Assertion that will be used to populate the {name} of users in Workspace.'
                values={{
                    name: attributeName,
                }}
            />
