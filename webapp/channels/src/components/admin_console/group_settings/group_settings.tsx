            ...
            <div className='admin-console__wrapper'>
                <div className='admin-console__content'>
                    ...
                    <AdminPanel
                        ...
                        subtitle={defineMessage({id: 'admin.group_settings.ldapGroupsDescription', defaultMessage: 'Connect AD/LDAP and create groups in Workspace. To get started, configure group attributes on the  configuration page.'})}
                    >
                        <GroupsList
                            readOnly={isDisabled}
                        />
