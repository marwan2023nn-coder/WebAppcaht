...
import type {GroupSearchOpts, MixedUnlinkedGroupRedux} from '@workspace/types/groups';
...
export default class GroupsList extends React.PureComponent<Props, State> {
    ...
    public linkSelectedGroups() {
        for (const group of this.props.groups) {
            if (this.state.checked[group.primary_key] && !group.Workspace_group_id) {
                ...
                <div className='group-content'>
                    <div className='group-description'>
                        <FormattedMessage
                            ...
                            defaultMessage='Workspace Linking'
                        />
                    </div>
