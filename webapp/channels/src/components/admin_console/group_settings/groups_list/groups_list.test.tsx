        ...
        const wrapper = shallow<GroupsList>(
            <GroupsList
                groups={[
                    ...
                    {primary_key: 'test2', name: 'test2', Workspace_group_id: 'group-id-1', has_syncables: false},
                ]}
                total={2}
                actions={{
                    getLdapGroups: jest.fn().mockReturnValue(Promise.resolve()),
        ...
        const wrapper = shallow<GroupsList>(
            <GroupsList
                groups={[
                    {primary_key: 'test1', name: 'test1'},
                    {primary_key: 'test2', name: 'test2', Workspace_group_id: 'group-id-1', has_syncables: false},
                    {primary_key: 'test3', name: 'test3', Workspace_group_id: 'group-id-1', has_syncables: false},
        ...
        const wrapper = shallow(
            <GroupsList
                groups={[
                    {primary_key: 'test1', name: 'test1'},
                    {primary_key: 'test2', name: 'test2', Workspace_group_id: 'group-id-1', has_syncables: false},
                    {primary_key: 'test3', name: 'test3', Workspace_group_id: 'group-id-2', has_syncables: true},
                ]}
                total={3}
                actions={{
                    getLdapGroups: jest.fn().mockReturnValue(Promise.resolve()),
