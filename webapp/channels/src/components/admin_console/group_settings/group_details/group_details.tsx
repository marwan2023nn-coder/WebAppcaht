...
import type {ChannelWithTeamData} from '@workspace/types/channels';
import {
    SyncableType,
...
import type {
    ...
    GroupPatch,
    GroupTeam,
    SyncablePatch} from '@workspace/types/groups';
                ...
                <div className='admin-console__wrapper'>
                    <div className='admin-console__content'>
                        ...
                        <AdminPanel
                            ...
                            subtitle={defineMessage({id: 'admin.group_settings.group_detail.groupUsersDescription', defaultMessage: 'Listing of users in Workspace associated with this group.'})}
                        >
                            <GroupUsers
                                members={members}
                                total={memberCount}
