...
import type {LocalizationSettings} from '@workspace/types/config';
                            ...
                            values={{
                                link: (msg: React.ReactNode) => (
                                    <ExternalLink
                                        ...
                                        href='https://translate.workspace.com/'
                                    >
                                        {msg}
                                    </ExternalLink>
                                ),
