...
import {uploadLicense, removeLicense, getPrevTrialLicense} from 'workspace-redux/actions/admin';
...
import {getFilteredUsersStats as selectFilteredUserStats} from 'workspace-redux/selectors/entities/users';
