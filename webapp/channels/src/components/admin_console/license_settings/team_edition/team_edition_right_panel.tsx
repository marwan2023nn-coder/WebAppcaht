            ...
            <div>
                ...
                <p className='upgrade-legal-terms'>
                    <FormattedMessage
                        ...
                        defaultMessage='By clicking <b>Upgrade</b>, I agree to the terms of the Workspace '
                        values={{
                            b: (chunks) => <b>{chunks}</b>,
                        }}
                    />
            ...
            <div>
                <p>
                    <FormattedMessage
                        ...
                        defaultMessage='You have upgraded your binary to workspace enterprise, please restart the server to start using the new binary. You can do it right here:'
                    />
                </p>
                <p>
                    <button
