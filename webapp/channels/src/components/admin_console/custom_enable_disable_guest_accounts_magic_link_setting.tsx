...
const messages = defineMessages({
    ...
    disableMagicLinkConfirmMessage: {id: 'admin.guest_access.disableMagicLinkConfirmMessage', defaultMessage: 'Disabling guest magic link access will revoke all current Guest Magic Link Account sessions. Those accounts will no longer be able to login and new guests cannot be invited into Workspace as passwordless accounts. These accounts will be marked as inactive in user lists. Enabling this feature will not reinstate previous guest magic link accounts. Are you sure you wish to remove these users?'},
