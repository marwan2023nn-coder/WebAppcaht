    ...
    return (
        <FeatureDiscovery
            ...
            title={defineMessage({
                ...
                defaultMessage: 'Enhance mobile app security with Workspace Enterprise',
            })}
            copy={defineMessage({
            ...
            learnMoreURL='https://docs.workspace.com/configure/environment-configuration-settings.html#mobile-security'
