...
describe('components/admin_console/feature_discovery/features/MobileSecurityFeatureDiscovery', () => {
    it('renders correctly with expected props', () => {
        ...
        // Verify title
        expect(screen.getByTestId('title')).toHaveTextContent('Enhance mobile app security with Workspace Enterprise');
        ...
        expect(screen.getByTestId('learn-more-url')).toHaveTextContent(
            'https://docs.workspace.com/configure/environment-configuration-settings.html#mobile-security',
        );
