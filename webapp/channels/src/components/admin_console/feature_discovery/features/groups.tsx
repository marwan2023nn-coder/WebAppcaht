    ...
    return (
        <FeatureDiscovery
            ...
            title={defineMessage({
                ...
                defaultMessage: 'Synchronize your Active Directory/LDAP groups with Workspace Enterprise',
            })}
            copy={defineMessage({
            ...
            learnMoreURL='https://docs.workspace.com/deployment/ldap-group-sync.html'
