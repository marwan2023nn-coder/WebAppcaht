    ...
    return (
        <FeatureDiscovery
            ...
            title={defineMessage({
                ...
                defaultMessage: 'Provide controlled access to the System Console with Workspace Enterprise',
            })}
            copy={defineMessage({
            ...
            learnMoreURL='https://docs.workspace.com/deployment/admin-roles.html'
