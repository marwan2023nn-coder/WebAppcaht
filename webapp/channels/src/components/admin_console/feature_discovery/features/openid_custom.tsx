    ...
    return (
        <FeatureDiscovery
            ...
            title={defineMessage({
                ...
                defaultMessage: 'Integrate OpenID Connect with Workspace Professional',
            })}
            copy={defineMessage({
            ...
            learnMoreURL='https://docs.workspace.com/cloud/cloud-administration/sso-openid-connect.html'
