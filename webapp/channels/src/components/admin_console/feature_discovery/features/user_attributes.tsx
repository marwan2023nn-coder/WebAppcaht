    ...
    return (
        <FeatureDiscovery
            ...
            title={defineMessage({
                ...
                defaultMessage: 'Add critical metadata to user profiles using custom user attributes with Workspace Enterprise',
            })}
            copy={defineMessage({
            ...
            learnMoreURL='https://docs.workspace.com/manage/admin/user-attributes.html'
