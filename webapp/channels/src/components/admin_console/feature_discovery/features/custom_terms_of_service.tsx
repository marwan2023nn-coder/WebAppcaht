    ...
    return (
        <FeatureDiscovery
            ...
            title={defineMessage({
                ...
                defaultMessage: 'Create custom terms of service with Workspace Enterprise',
            })}
            copy={defineMessage({
                id: 'admin.custom_terms_of_service_feature_discovery.copy',
                defaultMessage: 'Create your own terms of service that new users must accept before accessing your Workspace instance on desktop, web, or mobile.',
            })}
            learnMoreURL='https://docs.workspace.com/cloud/cloud-administration/custom-terms-of-service.html'
