    ...
    return (
        <FeatureDiscovery
            ...
            title={defineMessage({
                ...
                defaultMessage: 'Use attribute based access policies to control channel access with Workspace Enterprise Advanced',
            })}
            copy={defineMessage({
                id: 'admin.attribute_based_access_control_feature_discovery.desc',
                defaultMessage: 'Create policies containing access rules based on user attributes and apply them to channels and other resources within Workspace.',
            })}
            learnMoreURL='https://docs.workspace.com/deployment/'
