...
import type {CloudCustomer} from '@workspace/types/cloud';
...
import {goToWorkspaceContactSalesForm} from 'utils/contact_support_sales';
...
export default class FeatureDiscovery extends React.PureComponent<Props, State> {
    ...
    contactSalesFunc = () => {
        ...
        goToWorkspaceContactSalesForm(firstName, lastName, companyName, customerEmail, 'workspace', utmMedium);
    };
            ...
            <>
                ...
                {(!this.props.isCloud) && (<p className='trial-legal-terms'>
                    ...
                    <FormattedMessage
                        ...
                        defaultMessage='By clicking <highlight>Start trial</highlight>, I agree to the <linkEvaluation>Workspace Software and Services License Agreement</linkEvaluation>, <linkPrivacy>Privacy Policy</linkPrivacy> and receiving product emails.'
                        values={{
