...
describe('components/feature_discovery', () => {
    describe('FeatureDiscovery', () => {
        test('should match the default state of the component when is not cloud environment', async () => {
            ...
            renderWithContext(
                <FeatureDiscovery
                    ...
                    learnMoreURL='https://test.workspace.com/secondary/'
            ...
            await userEvent.click(screen.getByText('Workspace Software and Services License Agreement'));
            ...
            expect(featureLink).toHaveAttribute('href', 'https://test.workspace.com/secondary/?utm_source=workspace&utm_medium=in-product&utm_content=feature_discovery&uid=&sid=&edition=team&server_version=');
            expect(featureLink).toHaveTextContent('Learn more');
            expect(screen.getByText('Workspace Software and Services License Agreement')).toHaveAttribute('href', 'https://workspace.com/pl/software-and-services-license-agreement?utm_source=workspace&utm_medium=in-product&utm_content=feature_discovery&uid=&sid=&edition=team&server_version=');
            expect(screen.getByText('Privacy Policy')).toHaveAttribute('href', AboutLinks.PRIVACY_POLICY + '?utm_source=workspace&utm_medium=in-product&utm_content=feature_discovery&uid=&sid=&edition=team&server_version=');
        ...
        test('should match component state when is cloud environment', async () => {
            ...
            expect(screen.getByTestId('featureDiscovery_secondaryCallToAction')).toHaveAttribute('href', 'https://test.workspace.com/secondary/?utm_source=workspace&utm_medium=in-product&utm_content=feature_discovery&uid=&sid=&edition=team&server_version=');
