    ...
    if (isFreeTrial) {
        ...
        title = (
            <FormattedMessage
                ...
                defaultMessage='Looking to rollout Workspace for your entire organization? '
            />
        );
        description = (
            <FormattedMessage
                id='admin.billing.subscription.privateCloudCard.cloudEnterprise.description'
                defaultMessage="At Workspace, we work with you and your organization to meet your needs throughout the product. If you're considering a wider rollout, talk to us."
            />
        );
    } else {
