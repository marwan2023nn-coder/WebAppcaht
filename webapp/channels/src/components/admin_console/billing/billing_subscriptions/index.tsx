...
import {getCloudSubscription, getCloudProducts, getCloudCustomer} from 'workspace-redux/actions/cloud';
import {
    getSubscriptionProduct,
    getCloudSubscription as selectCloudSubscription,
    getCloudErrors,
} from 'workspace-redux/selectors/entities/cloud';
                ...
                <div className='admin-console__content'>
                    ...
                    {!errorLoadingData && <>
                        ...
                        <ContactSalesCard
                            isFreeTrial={isFreeTrial}
                            subscriptionPlan={product?.sku}
                            onUpgradeWorkspaceCloud={openPricingModal}
                        />
                    </>}
                </div>
            </div>
