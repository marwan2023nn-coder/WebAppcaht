...
import {CheckCircleOutlineIcon} from '@workspace/compass-icons/components';
import type {Invoice, InvoiceLineItem, Product} from '@workspace/types/cloud';
...
export const FreeTrial = ({daysLeftOnTrial}: FreeTrialProps) => {
    ...
    return (
        <div className='UpgradeWorkspaceCloud'>
            <div className='UpgradeWorkspaceCloud__image'>
                <UpgradeSvg
                    height={167}
                    width={234}
                />
            </div>
            <div className='UpgradeWorkspaceCloud__title'>
            ...
            <div className='UpgradeWorkspaceCloud__description'>
            ...
            <button
                ...
                className='UpgradeWorkspaceCloud__upgradeButton btn btn-primary'
            >
                <FormattedMessage
