...
describe('components/admin_console/billing/billing_history', () => {
    ...
    test('Billing history section shows template when no invoices have been emitted yet', () => {
        ...
        expect(screen.getByRole('link')).toHaveAttribute('href', CloudLinks.BILLING_DOCS + '?utm_source=workspace&utm_medium=in-product-cloud&utm_content=billing_history&uid=current_user_id&sid=&edition=team&server_version=');
