...
import type {AdminConfig, ClientLicense, EmailSettings} from '@workspace/types/config';
        ...
        if (this.state.pushNotificationServerType === PUSH_NOTIFICATIONS_OFF) {
            ...
            pushServerHelpText = (
                <FormattedMessage
                    ...
                    defaultMessage='Download <linkIOS>Workspace iOS app</linkIOS> from iTunes. Download <linkAndroid>Workspace Android app</linkAndroid> from Google Play. Learn more about the <linkHPNS>Workspace Hosted Push Notification Service</linkHPNS>.'
                    values={{
                        linkIOS: (msg) => (
                            <ExternalLink
                                href='https://workspace.com/pl/ios-app/'
                                location='push_settings'
                            >
                                {msg}
                            </ExternalLink>
                        ...
                        linkAndroid: (msg) => (
                            <ExternalLink
                                href='https://workspace.com/pl/android-app/'
                                location='push_settings'
                            >
                                {msg}
                            </ExternalLink>
                ...
                <div className='form-group'>
                    ...
                    <div className='col-sm-8'>
                        ...
                        <FormattedMessage
                            ...
                            defaultMessage=' I understand and accept the Workspace Hosted Push Notification Service <linkTerms>Terms of Service</linkTerms> and <linkPrivacy>Privacy Policy</linkPrivacy>.'
                            values={{
                                linkTerms: (msg) => (
                                    <ExternalLink
                                        href='https://workspace.com/hpns-terms/'
                                        location='push_settings'
                                    >
                                        {msg}
                                    </ExternalLink>
                                ...
                                linkPrivacy: (msg) => (
                                    <ExternalLink
                                        href='https://workspace.com/data-processing-addendum/'
                                        location='push_settings'
                                    >
                                        {msg}
                                    </ExternalLink>
        ...
        return (
            <SettingsGroup>
                ...
                <TextSetting
                    ...
                    placeholder={defineMessage({id: 'admin.email.pushServerEx', defaultMessage: 'E.g.: "https://push-test.workspace.com"'})}
