...
import type {Channel, ChannelModeration as ChannelPermissions, ChannelModerationPatch} from '@workspace/types/channels';
import {SyncableType} from '@workspace/types/groups';
import type {SyncablePatch, Group} from '@workspace/types/groups';
