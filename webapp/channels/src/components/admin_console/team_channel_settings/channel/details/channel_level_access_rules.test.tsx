...
import type {UserPropertyField, FieldVisibility, FieldValueType} from '@workspace/types/properties';
...
jest.mock('workspace-redux/selectors/entities/access_control', () => ({
