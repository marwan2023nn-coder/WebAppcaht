...
import {getConfig, getEnvironmentConfig, patchConfig} from 'workspace-redux/actions/admin';
...
import * as Selectors from 'workspace-redux/selectors/entities/admin';
import {getConfig as getGeneralConfig, getLicense} from 'workspace-redux/selectors/entities/general';
...
import {getCurrentTeam, getTeam} from 'workspace-redux/selectors/entities/teams';
import {isCurrentUserSystemAdmin, currentUserHasAnAdminRole, getCurrentUserId} from 'workspace-redux/selectors/entities/users';
...
function mapStateToProps(state: GlobalState) {
    ...
    const team = currentTeam ?? getTeam(state, teamId || '');
