...
import {ArchiveOutlineIcon, GlobeIcon, LockIcon} from '@workspace/compass-icons/components';
import type IconProps from '@workspace/compass-icons/components/props';
import {GenericModal} from '@workspace/components';
import type {Channel, ChannelWithTeamData} from '@workspace/types/channels';
