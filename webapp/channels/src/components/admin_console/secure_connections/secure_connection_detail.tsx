...
import {GlobeIcon, LockIcon, PlusIcon, ArchiveOutlineIcon} from '@workspace/compass-icons/components';
import {isRemoteClusterPatch, type RemoteCluster} from '@workspace/types/remote_clusters';
                                    ...
                                    helpText={(
                                        <FormattedMessage
                                            ...
                                            values={{
                                                link: (
                                                    <ExternalLink
                                                        href='https://workspace.com/pl/connected-workspaces-destination'
