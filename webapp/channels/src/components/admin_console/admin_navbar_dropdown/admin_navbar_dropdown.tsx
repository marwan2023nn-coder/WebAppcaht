    ...
    render(): JSX.Element {
        ...
        let commercialSupport = (
            <Menu.ItemExternalLink
                url='https://workspace.com/support/'
        ...
        return (
            <Menu className='Admin-Console-Menu' ariaLabel={formatMessage({id: 'admin.nav.menuAriaLabel', defaultMessage: 'Admin Console Menu'})}>
                <Menu.Group>
                    {teamToRender}
                    {switchTeams}
                </Menu.Group>
                <Menu.Group>
                    ...
                    <Menu.ItemToggleModalRedux
                        ...
                        text={formatMessage({id: 'navbar_dropdown.about', defaultMessage: 'About {appTitle}'}, {appTitle: siteName || 'Workspace'})}
                    />
                </Menu.Group>
                <Menu.Group>
                    <Menu.ItemAction
