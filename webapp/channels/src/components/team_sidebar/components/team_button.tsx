    ...
    const btn = (
        ...
        >
            <div className='TeamButton'>
                <div className={classNames('team-btn', btnClass)}>
                    {!otherProps.isInProduct && badge}
                    {content}
                </div>
                {isNotCreateTeamButton && (
                    <span className='TeamButton__name'>
                        <span className='TeamButton__nameText'>
                            {displayName}
                        </span>
                    </span>
                )}
...
function WithTeamTooltip({
    ...
    const [teamNamesVisible, setTeamNamesVisible] = useState(() => {
        return document.getElementById('root')?.classList.contains('team-sidebar--show-names') ?? false;
    });
    ...
    useEffect(() => {
        ...
        const update = () => {
            setTeamNamesVisible(root.classList.contains('team-sidebar--show-names'));
        };
