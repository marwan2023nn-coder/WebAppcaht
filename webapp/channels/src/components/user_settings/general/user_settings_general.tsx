...
import type {UserPropertyField, PropertyFieldOption} from '@workspace/types/properties';
import type {UserProfile} from '@workspace/types/users';

import type {LogErrorOptions} from 'workspace-redux/actions/errors';
import {LogErrorBarMode} from 'workspace-redux/actions/errors';
...
export class UserSettingsGeneralTab extends PureComponent<Props, State> {
    ...
    createEmailSection() {
        ...
        const disabled = Boolean(this.props.lockTeammateNameDisplay);
        let max = null;
        if (active) {
