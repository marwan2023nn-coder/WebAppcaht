...
import {LightbulbOutlineIcon} from '@workspace/compass-icons/components';
import type {PreferencesType} from '@workspace/types/preferences';
import type {UserNotifyProps, UserProfile} from '@workspace/types/users';
...
import Constants, {NotificationLevels, WorkspaceFeatures, LicenseSkus, UserSettingsNotificationSections} from 'utils/constants';
    ...
    createKeywordsWithHighlightSection = () => {
        ...
        const collapsedEditButtonWhenDisabled = (
            <RestrictedIndicator
                ...
                feature={WorkspaceFeatures.HIGHLIGHT_WITHOUT_NOTIFICATION}
                ...
                titleAdminPreTrial={this.props.intl.formatMessage({
                    ...
                    defaultMessage: 'Highlight keywords without notifications with Workspace Professional',
                })}
                ...
                messageEndUser={this.props.intl.formatMessage(
                    {
                        ...
                        defaultMessage: 'Get the ability to passively highlight keywords that you care about.{br}{br}Request your admin to upgrade to Workspace Professional to access this feature.',
                    },
                    {
                        br: <br/>,
                    },
            ...
            >
                ...
                >
                    <SettingDesktopHeader
                        ...
                        //                     href='https://workspace.com/pl/about-notifications'
