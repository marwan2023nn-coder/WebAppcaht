...
export default function NotificationPermissionUnsupportedSectionNotice() {
    ...
    const handleClick = useCallback(async () => {
        window.open('https://workspace.com/pl/pc-web-requirements', '_blank', 'noopener,noreferrer');
    }, []);
        ...
        <div className='extraContentBeforeSettingList'>
            <SectionNotice
                ...
                text={intl.formatMessage({
                    ...
                    defaultMessage: 'You\'re missing important message and call notifications from Workspace. To start receiving notifications, please update to a supported browser.',
                })}
                tertiaryButton={{
                    text: intl.formatMessage({
