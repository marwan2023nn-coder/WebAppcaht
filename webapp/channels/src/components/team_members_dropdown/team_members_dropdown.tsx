...
import type {isCollapsedThreadsEnabled} from 'workspace-redux/selectors/entities/preferences';
import type {ActionResult} from 'workspace-redux/types/actions';
import {isGuest, isAdmin, isSystemAdmin} from 'workspace-redux/utils/user_utils';
            ...
            const message = (
                <div>
                    <FormattedMessage
                        ...
                        defaultMessage="If you demote yourself from the System Admin role and there is not another user with System Admin privileges, you'll need to re-assign a System Admin by accessing the Workspace server through a terminal and running the following command."
                    />
                    <br/>
                    <br/>
                    <FormattedMessage
