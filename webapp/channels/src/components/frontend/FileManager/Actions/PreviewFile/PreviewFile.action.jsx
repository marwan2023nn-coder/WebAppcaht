...
const PreviewFileAction = ({ filePreviewPath = `http://localhost:3000/uploads`}) => {
  ...
  // const filePath = `http://localhost:3000/uploads/Pictures/WIN_20241028_15_51_11_Pro.jpg`;
  // const filePath = `http://localhost:3000/uploads/Pictures/design-for-developers_compress.pdf`;
  // console.log(filePreviewPath)
  // console.log(`${filePreviewPath}${selectedFiles[0].path}`)
      ...
      {hasError ||
        (![
          ...
          <div className="preview-error">
            ...
            <span className="error-msg">المعذرة! المعاينة غير متاحة لهذا الملف.
            </span>
