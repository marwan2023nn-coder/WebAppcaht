...
import {ArchiveOutlineIcon, CheckIcon, ChevronDownIcon, GlobeIcon, LockOutlineIcon, AccountOutlineIcon, GlobeCheckedIcon} from '@workspace/compass-icons/components';
...
import {isPrivateChannel} from 'workspace-redux/utils/channel_utils';
