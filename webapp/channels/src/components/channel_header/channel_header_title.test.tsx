...
import {fetchChannelRemotes} from 'packages/workspace-redux/src/actions/shared_channels';
import {getRemoteNamesForChannel} from 'packages/workspace-redux/src/selectors/entities/shared_channels';
...
jest.mock('workspace-redux/utils/helpers', () => ({
...
jest.mock('workspace-redux/selectors/create_selector', () => ({
