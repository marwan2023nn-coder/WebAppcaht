...
import {type UserCustomStatus, CustomStatusDuration} from '@workspace/types/users';

import {unsetCustomStatus} from 'workspace-redux/actions/users';
    ...
    return (
        <Menu.Item
            ...
            leadingElement={
                <CustomStatusEmoji
                    showTooltip={false}
                    emojiStyle={{marginInlineStart: 0}}
                    emojiSize={16}
                />
            }
            labels={label}
