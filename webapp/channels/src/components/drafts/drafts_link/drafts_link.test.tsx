...
jest.mock('workspace-redux/actions/scheduled_posts', () => ({
...
describe('components/drafts/drafts_link', () => {
    ...
    it('should fetch scheduled posts when component mounts', async () => {
        const fetchTeamScheduledPosts = require('workspace-redux/actions/scheduled_posts').fetchTeamScheduledPosts;
