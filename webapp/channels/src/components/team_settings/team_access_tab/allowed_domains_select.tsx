        ...
        <>
            <CheckboxSettingItem
                ...
                description={formatMessage({
                    ...
                    defaultMessage: 'When enabled, users can only join the team if their email matches a specific domain (e.g. "workspace.org")',
                })}
            ...
            <SelectTextInput
                id='allowedDomains'
                placeholder={formatMessage({id: 'general_tab.AllowedDomainsExample', defaultMessage: 'corp.workspace.com, workspace.com'})}
