...
describe('components/TeamSettings/OpenInvite', () => {
    ...
    test('should render correct title and link when the team is constrained', () => {
        ...
        expect(externalLink).toHaveAttribute('href', 'https://workspace.com/pl/default-ldap-group-constrained-team-channel.html?utm_source=workspace&utm_medium=in-product&utm_content=open_invite&uid=&sid=&edition=team&server_version=');
    });
