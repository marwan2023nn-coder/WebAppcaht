...
import {AlertOutlineIcon} from '@workspace/compass-icons/components';
...
import {getServerLimits} from 'workspace-redux/selectors/entities/limits';
...
const learnMoreExternalLink = 'https://workspace.com/pl/error-code-error-safety-limits-exceeded';
