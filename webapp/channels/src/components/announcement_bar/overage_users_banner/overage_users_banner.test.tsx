...
jest.mock('workspace-redux/actions/cloud', () => ({
    getLicenseSelfServeStatus: jest.fn(),
}));

const seatsPurchased = 40;
const email = 'test@workspace.com';
...
describe('components/overage_users_banner', () => {
    ...
    it('should track if the admin click Contact Sales CTA in a 10% overage state', () => {
        ...
        const salesLinkWithEncodedParams = 'https://workspace.com/contact-sales/?qk=&qp=&qw=&qx=dGVzdEBtYXR0ZXJtb3N0LmNvbQ==&utm_source=workspace&utm_medium=in-product';
