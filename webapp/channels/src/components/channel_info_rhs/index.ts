...
import {unfavoriteChannel, favoriteChannel, getChannelStats} from 'workspace-redux/actions/channels';
import {Permissions} from 'workspace-redux/constants';
import {getCurrentChannel, isCurrentChannelFavorite, isCurrentChannelMuted, isCurrentChannelArchived, getCurrentChannelStats} from 'workspace-redux/selectors/entities/channels';
...
import {getProfilesInCurrentChannel, getStatusForUserId, getUser} from 'workspace-redux/selectors/entities/users';
