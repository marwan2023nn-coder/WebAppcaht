...
import {getSubscriptionProduct, checkHadPriorTrial} from 'workspace-redux/selectors/entities/cloud';
...
import {CloudProducts, LicenseSkus, ModalIdentifiers, WorkspaceFeatures} from 'utils/constants';
...
export default function InviteAs(props: Props) {
    ...
    if (isSystemAdmin && !isPaidSubscription) {
        ...
        const restrictedIndicator = (
            <RestrictedIndicator
                blocked={!isFreeTrial}
                feature={WorkspaceFeatures.GUEST_ACCOUNTS}
