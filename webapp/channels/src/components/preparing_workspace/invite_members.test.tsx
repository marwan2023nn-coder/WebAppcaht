...
describe('InviteMembers component', () => {
    ...
    beforeEach(() => {
        defaultProps = {
            disableEdits: false,
            browserSiteUrl: 'https://my-org.workspace.com',
            formUrl: 'https://my-org.workspace.com/signup',
            teamInviteId: '1234',
            className: 'test-class',
            configSiteUrl: 'https://my-org.workspace.com/config',
    ...
    it('renders invite URL', () => {
        ...
        expect(inviteLink).toHaveAttribute(
            'value',
            'https://my-org.workspace.com/config/signup_user_complete/?id=1234',
        );
    });
