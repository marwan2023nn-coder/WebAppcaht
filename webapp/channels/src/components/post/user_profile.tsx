...
type Props = {
    ...
    location: string;
    burnOnReadBadge?: ReactNode;
};

const PostUserProfile = (props: Props): JSX.Element | null => {
    const intl = useIntl();
    const { post, compactDisplay, isMobileView, isConsecutivePost, enablePostUsernameOverride, isBot, isSystemMessage, colorizeUsernames, location, burnOnReadBadge } = props;
