...
import type {UserProfile, UserAccessToken} from '@workspace/types/users';
                ...
                helpText={
                    <>
                        <FormattedMessage
                            ...
                            defaultMessage='Use {botAccounts} to integrate with Workspace through plugins or the API. Bot accounts are available to everyone on your server. '
                            values={{
                                botAccounts: (
                                    <ExternalLink
