...
import type {OutgoingOAuthConnection} from '@workspace/types/integrations';
import type {Team} from '@workspace/types/teams';

import {deleteOutgoingOAuthConnection} from 'workspace-redux/actions/integrations';
import {Permissions} from 'workspace-redux/constants';
import {getConfig} from 'workspace-redux/selectors/entities/general';
import {getOutgoingOAuthConnections} from 'workspace-redux/selectors/entities/integrations';
        ...
        <BackstageList
            ...
            helpText={
                <FormattedMessage
                    ...
                    defaultMessage='Create {outgoingOauthConnections} to securely integrate bots and third-party apps with Workspace.'
                    values={{
