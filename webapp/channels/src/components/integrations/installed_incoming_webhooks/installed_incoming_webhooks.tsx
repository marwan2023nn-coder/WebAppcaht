...
import type {IncomingWebhook, IncomingWebhooksWithCount} from '@workspace/types/integrations';
            ...
            <BackstageList
                ...
                helpText={
                    <FormattedMessage
                        ...
                        defaultMessage='Use incoming webhooks to connect external tools to Workspace. {buildYourOwn} or visit the {appDirectory} to find self-hosted, third-party apps and integrations.'
                        values={{
                            buildYourOwn: (
                                <ExternalLink
