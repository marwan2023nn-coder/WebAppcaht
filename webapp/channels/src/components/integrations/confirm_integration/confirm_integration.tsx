...
import type {Command, IncomingWebhook, OAuthApp, OutgoingOAuthConnection, OutgoingWebhook} from '@workspace/types/integrations';
        ...
        helpText = (
            <p>
                <FormattedMessage
                    ...
                    defaultMessage='Your slash command is set up. The following token will be sent in the outgoing payload. Please use it to verify the request came from your Workspace team (details at <link>Slash Commands</link>).'
                    values={{
                        link: (msg) => (
                            <ExternalLink
        ...
        helpText = (
            <p>
                <FormattedMessage
                    ...
                    defaultMessage='Your outgoing webhook is set up. The following token will be sent in the outgoing payload. Please use it to verify that the request came from your Workspace team (details at <link>Outgoing Webhooks</link>).'
                    values={{
                        link: (msg) => (
                            <ExternalLink
        ...
        helpText = (
            <p>
                <FormattedMessage
                    ...
                    defaultMessage='Your bot account **{botname}** has been created successfully. Please use the following access token to connect to the bot (see [documentation](https://workspace.com/pl/default-bot-accounts) for further details).'
                    values={{
