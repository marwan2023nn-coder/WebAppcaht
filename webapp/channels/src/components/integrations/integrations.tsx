                    ...
                    <IntegrationOption
                        ...
                        description={
                            <FormattedMessage
                                ...
                                defaultMessage='Auth 2.0 allows external applications to make authorized requests to the Workspace API'
                            />
                        }
                ...
                <IntegrationOption
                    ...
                    description={
                        <FormattedMessage
                            ...
                            defaultMessage='Use bot accounts to integrate with Workspace through plugins or the API'
                        />
                    }
            ...
            <div className='backstage-content row'>
                ...
                <div className='backstage-list__help'>
                    <FormattedMessage
                        ...
                        defaultMessage='Visit the {appDirectory} to find self-hosted, third-party apps and integrations for Workspace.'
                        values={{
                            appDirectory: (
                                <ExternalLink
                                    href='https://workspace.com/marketplace'
