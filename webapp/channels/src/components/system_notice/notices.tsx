...
const notices: Notice[] = [
    {
        ...
        title: (
            <FormattedMessage
                ...
                defaultMessage='Notice from Workspace'
            />
        ),
        body: (
            <FormattedMessage
                ...
                values={{
                    link: (msg: React.ReactNode) => (
                        <ExternalLink
                            href='https://api.workspace.com/#tag/APIv3-Deprecation'
    ...
    },
    {
        ...
        body: (
            <FormattedMessage
                ...
                defaultMessage='Some policy and permission System Console settings have moved with the release of <link>advanced permissions</link> into Workspace Free and Professional.'
                values={{
                    link: (msg: React.ReactNode) => (
                        <ExternalLink
        ...
        body: (
            <FormattedMessage
                ...
                values={{
                    link: (msg: React.ReactNode) => (
                        <ExternalLink
                            href='https://workspace.com/performance'
                            location='system_notices'
                        >
                            {msg}
                        </ExternalLink>
        ...
        body: (
            <FormattedMessage
                ...
                values={{
                    link: (msg: React.ReactNode) => (
                        <ExternalLink
                            href='https://forum.workspace.com/t/workspace-is-dropping-support-for-internet-explorer-ie11-in-v5-16/7575'
                            location='system_notices'
                        >
                            {msg}
                        </ExternalLink>
