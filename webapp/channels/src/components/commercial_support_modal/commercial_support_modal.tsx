...
export default class CommercialSupportModal extends React.PureComponent<Props, State> {
    ...
    render() {
        ...
        const supportLink = isCloud ? `https://customers.workspace.com/cloud/contact-us?name=${currentUser.first_name} ${currentUser.last_name}&email=${currentUser.email}&inquiry=technical` : 'https://local-workspace.sofa.ye/hc/en-us/requests/new';
        return (
            <Modal
                ...
                <Modal.Body>
                    <div className='CommercialSupportModal'>
                        <FormattedMessage
                            ...
                            defaultMessage={'If you\'re experiencing issues, <supportLink>submit a support ticket</supportLink>. To help with troubleshooting, it\'s recommended to download the Support Packet below that includes more details about your Workspace environment.'}
                            values={{
                                supportLink: (chunks) => (
                                    <ExternalLink
                                        href={supportLink}
