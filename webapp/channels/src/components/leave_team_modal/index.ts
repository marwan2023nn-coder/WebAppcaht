...
import {removeUserFromTeam as leaveTeam} from 'workspace-redux/actions/teams';
...
import {getCurrentUserId, getCurrentUser} from 'workspace-redux/selectors/entities/users';
