...
describe('components/analytics/system_analytics/system_analytics.tsx', () => {
    ...
    />,
        ...
        const state = {
            ...
            plugins: {
                siteStatsHandlers: {
                    'com.workspace.calls': () => callsStats,
                    'com.workspace.playbooks': () => playbooksStats,
                },
            },
        };
        ...
        expect(screen.getByTestId('totalPosts')).toHaveTextContent('45');
        expect(screen.getByTestId('totalPostsLineChart')).toBeInTheDocument();
        expect(screen.getByTestId('com.workspace.playbooks.playbook_count')).toHaveTextContent('45');
        expect(screen.getByTestId('com.workspace.playbooks.playbook_run_count')).toHaveTextContent('45');

        expect(screen.getByTestId('com.workspace.calls.calls_count')).toHaveTextContent('1000');
        expect(screen.getByTestId('com.workspace.calls.calls_sessions_count')).toHaveTextContent('10000');
