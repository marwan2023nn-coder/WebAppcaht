...
import {EmoticonPlusOutlineIcon, InformationOutlineIcon} from '@workspace/compass-icons/components';
...
import {scheduledPostToPost} from '@workspace/types/schedule_post';
