...
import {getCloudSubscription, getSubscriptionProduct} from 'workspace-redux/selectors/entities/cloud';
...
import {getJoinableTeamIds, getCurrentTeamId, getMyTeamMember} from 'workspace-redux/selectors/entities/teams';
...
import {LicenseSkus, ModalIdentifiers, WorkspaceFeatures, CloudProducts} from 'utils/constants';
...
function RestrictedIndicatorForCreateTeam({isFreeTrial}: {isFreeTrial: boolean}) {
    ...
    return (
        <RestrictedIndicator
            feature={WorkspaceFeatures.CREATE_MULTIPLE_TEAMS}
...
// const Workspace_ACADEMY_TEAM_TRAINING_LINK = 'https://workspace.com/pl/workspace-academy-team-training';

// function LearnAboutTeamsMenuItem() {
//     const handleClick = useCallback(() => {
//         window.open(Workspace_ACADEMY_TEAM_TRAINING_LINK, '_blank', 'noopener noreferrer');
//     }, []);
