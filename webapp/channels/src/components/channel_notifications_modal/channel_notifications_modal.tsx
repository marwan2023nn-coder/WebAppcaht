...
import {BellOffOutlineIcon} from '@workspace/compass-icons/components';
import {GenericModal} from '@workspace/components';
import type {Channel, ChannelMembership, ChannelNotifyProps} from '@workspace/types/channels';
        ...
        <>
            ...
            <ModalSection
                ...
                description={formatMessage({
                    ...
                    defaultMessage: 'Available on Chrome, Edge, Firefox, and the Workspace Desktop App.',
                })}
            ...
            <ModalSection
                ...
                description={formatMessage({
                    ...
                    defaultMessage: 'Notification alerts are pushed to your mobile device when there is activity in Workspace.',
                })}
