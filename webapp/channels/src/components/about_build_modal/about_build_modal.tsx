    ...
    let learnMore = (
        <div>
            <FormattedMessage
                ...
                defaultMessage='Join the Workspace community at '
            />
            <ExternalLink
                location='about_build_modal'
                href='https://workspace.com/community/'
            >
                {'workspace.com/community/'}
            </ExternalLink>
        </div>
    );
            ...
            learnMore = (
                <div>
                    <FormattedMessage
                        ...
                        defaultMessage='Learn more about Workspace {planName} at '
            ...
            <Modal.Header closeButton={true}>
                ...
                >
                    <FormattedMessage
                        id='about.title'
                        values={{
                            appTitle: config.SiteName || 'مساحة عمل سوفا',
                        }}
            ...
            <Modal.Body>
                ...
                {/* <div className='about-modal__footer'>
                    ...
                    <div className='form-group'>
                        <div className='about-modal__copyright'>
                            <FormattedMessage
                                id='about.copyright'
                                defaultMessage='Copyright 2015 - {currentYear} Workspace, Inc. All rights reserved'
                                values={{
                ...
                <div className='about-modal__notice form-group pt-3'>
                    <p>
                        <FormattedMessage
                            id='about.notice'
                            defaultMessage='Workspace is made possible by the open source software used in our <linkServer>server</linkServer>, <linkDesktop>desktop</linkDesktop> and <linkMobile>mobile</linkMobile> apps.'
                            values={{
                                linkServer: (msg: React.ReactNode) => (
                                    <ExternalLink
                                        location='about_build_modal'
                                        href='https://github.com/workspace/workspace-server/blob/master/NOTICE.txt'
                                    >
                                        {msg}
                                    </ExternalLink>
                                ),
                                linkDesktop: (msg: React.ReactNode) => (
                                    <ExternalLink
                                        location='about_build_modal'
                                        href='https://github.com/workspace/desktop/blob/master/NOTICE.txt'
                                    >
                                        {msg}
                                    </ExternalLink>
                                ),
                                linkMobile: (msg: React.ReactNode) => (
                                    <ExternalLink
                                        location='about_build_modal'
                                        href='https://github.com/workspace/workspace-mobile/blob/master/NOTICE.txt'
                                    >
                                        {msg}
                                    </ExternalLink>
                                ),
