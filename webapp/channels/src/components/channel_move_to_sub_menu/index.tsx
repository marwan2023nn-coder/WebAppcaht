...
import {getCategoryInTeamWithChannel} from 'workspace-redux/selectors/entities/channel_categories';
...
const ChannelMoveToSubMenu = (props: Props) => {
    ...
    return (
        <Menu.SubMenu
            ...
            trailingElements={<ChevronRightIcon size={16} className='chevron-right' />}
