...
// import {AlertCircleOutlineIcon} from '@workspace/compass-icons/components';
import type {PostPriorityMetadata} from '@workspace/types/posts';
import {PostPriority} from '@workspace/types/posts';

import {getPersistentNotificationIntervalMinutes, isPersistentNotificationsEnabled, isPostAcknowledgementsEnabled} from 'workspace-redux/selectors/entities/posts';
...
import MessagePriorityIcon from './svg_Message _priority';
