...
import {replaceEmojiCodes} from '../sidebar/sidebar_channel/sidebar_channel_link/emoji_helper';
...
export default class Textbox extends React.PureComponent<Props> {
    ...
    constructor(props: Props) {
      ...
      handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        const processedValue = replaceEmojiCodes(newValue);

        // أنشئ event جديد بالقيمة المعالجة
    ...
    render() {
         const displayValue = replaceEmojiCodes(this.props.value);
