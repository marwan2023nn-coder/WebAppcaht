...
/* eslint-disable @workspace/use-external-link */
...
import {DownloadOutlineIcon, LinkVariantIcon, CheckIcon} from '@workspace/compass-icons/components';
...
import {getFileMiniPreviewUrl} from 'workspace-redux/utils/file_utils';
