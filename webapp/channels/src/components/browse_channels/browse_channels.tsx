...
import type {Channel, ChannelMembership, ChannelSearchOpts, ChannelsWithTotalCount} from '@workspace/types/channels';
    ...
    render() {
        ...
        const noResultsText = (
            <>
                ...
                {createNewChannelButton('btn-primary',<PlusIcon size={'1.8rem'}/>)}
            </>
        );
