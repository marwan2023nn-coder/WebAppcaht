...
import {ChevronLeftIcon, ChevronRightIcon} from '@workspace/compass-icons/components';
...
import {getAgents as getAgentsSelector} from 'workspace-redux/selectors/entities/agents';
