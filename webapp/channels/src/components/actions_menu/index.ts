...
import {AppBindingLocations} from 'workspace-redux/constants/apps';
...
import {isMarketplaceEnabled, getFeatureFlagValue} from 'workspace-redux/selectors/entities/general';
