...
describe('ExternalIImage isSVGImage', () => {
    for (const testCase of [
        ...
        },
        {
            ...
            src: 'https://workspace.example.com/api/v4/image?url=' + encodeURIComponent('https://example.com/image.png'),
            imageMetadata: undefined,
            expected: false,
        },
        {
            name: 'no metadata, proxied svg image',
            src: 'https://workspace.example.com/api/v4/image?url=' + encodeURIComponent('https://example.com/image.svg'),
            imageMetadata: undefined,
            expected: true,
        },
        {
