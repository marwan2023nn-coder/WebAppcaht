                ...
                <CompletedWrapper>
                    ...
                    <span className='completed-subtitle'>
                        <FormattedMessage
                            ...
                            defaultMessage='We hope Workspace is more familiar now.'
                        />
                    </span>
                                ...
                                values={{
                                    link: (msg: React.ReactNode) => (
                                        <ExternalLink
                                            ...
                                            href={encodeURI('/files/sofa-desktop-6.1.0-develop.1-win-x64 (3).msi')}
                                            download={true}
                                        >
                                            {msg}
                                        </ExternalLink>
                    ...
                    {showStartTrialBtn && <div className='disclaimer'>
                        <span>
                            <FormattedMessage
                                ...
                                defaultMessage='By clicking “Start trial”, I agree to the <linkEvaluation>Workspace Software and Services License Agreement</linkEvaluation>, <linkPrivacy>privacy policy</linkPrivacy> and receiving product emails.'
                                values={{
