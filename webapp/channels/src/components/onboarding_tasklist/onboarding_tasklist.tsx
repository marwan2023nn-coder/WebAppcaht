...
import {CloseIcon, PlaylistCheckIcon} from '@workspace/compass-icons/components';

import {getPrevTrialLicense} from 'workspace-redux/actions/admin';
import {getMyPreferences, savePreferences} from 'workspace-redux/actions/preferences';
                ...
                <TaskItems className={open ? 'open' : ''}>
                    {completedCount === tasksList.length ? (
                        ...
                        <>
                            <h1>
                                <FormattedMessage
                                    id='next_steps_view.welcoworkspace'
