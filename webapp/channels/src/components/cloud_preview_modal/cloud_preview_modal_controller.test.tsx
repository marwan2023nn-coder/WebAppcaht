...
import type {Subscription, PreviewModalContentData} from '@workspace/types/cloud';
import type {TeamType} from '@workspace/types/teams';
...
describe('CloudPreviewModal', () => {
    ...
    it('should fallback to hardcoded content when dynamic content is not available', () => {
        ...
        expect(lastContentData[0].title.defaultMessage).toBe('Welcome to your Workspace preview');
    });
