...
import type {TeamMembership, TeamStats, GetTeamMembersOpts} from '@workspace/types/teams';
import type {UserProfile} from '@workspace/types/users';

import {Teams} from 'workspace-redux/constants';
...
import MemberListTeamUserRow from './member_list_team_user_row';
    ...
    render() {
        ...
        return (
            <SearchableUserList
                ...
                rowComponentType={MemberListTeamUserRow}
