# CLAUDE: `packages/workspace-redux/`

## Purpose
- Embedded copy of the `workspace-redux` package for local development.
...
## Import Convention
Import from workspace-reduxusing the package alias:
...
// Types come from @workspace/types
