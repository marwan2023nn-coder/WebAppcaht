...
import type {FileSearchResults, FileSearchResultItem} from '@workspace/types/files';
import type {PostList, PostSearchResults} from '@workspace/types/posts';
import type {SearchParameter} from '@workspace/types/search';
...
import type {ActionResult, ActionFuncAsync, ThunkActionFunc} from 'workspace-redux/types/actions';
