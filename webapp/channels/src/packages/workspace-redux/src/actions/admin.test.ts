...
import type {CreateDataRetentionCustomPolicy} from '@workspace/types/data_retention';

import * as Actions from 'workspace-redux/actions/admin';
...
describe('Actions.Admin', () => {
    ...
    it('getConfig', async () => {
        ...
        expect(config.TeamSettings.SiteName === 'Workspace').toBeTruthy();
    });
    ...
    it('patchConfig', async () => {
        ...
        const testSiteName = 'WorkspaceReduxTest';
    ...
    it('uploadBrandImage', async () => {
        const testImageData = fs.createReadStream('src/packages/workspace-redux/test/assets/images/test.png');
    ...
    it('uploadPublicSamlCertificate', async () => {
        const testFileData = fs.createReadStream('src/packages/workspace-redux/test/assets/images/test.png');
    ...
    it('getLdapGroups', async () => {
        const ldapGroups = {
            count: 2,
            groups: [
                {primary_key: 'test1', name: 'test1', Workspace_group_id: null, has_syncables: false},
                {primary_key: 'test2', name: 'test2', Workspace_group_id: 'workspace-id', has_syncables: true},
            ],
        };
    ...
    it('linkLdapGroup', async () => {
        ...
        nock(Client4.getBaseRoute()).
            ...
            reply(200, {display_name: 'test1', id: 'new-workspace-id'});
        ...
        expect(groups[key].Workspace_group_id === 'new-workspace-id').toBeTruthy();
    ...
    it('unlinkLdapGroup', async () => {
        ...
        const groups = state.entities.admin.ldapGroups;
        expect(groups[key]).toBeTruthy();
        expect(groups[key].Workspace_group_id === undefined).toBeTruthy();
