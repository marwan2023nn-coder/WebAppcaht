...
import * as Actions from 'workspace-redux/actions/files';
...
describe('Actions.Files', () => {
    ...
    it('getFilesForPost', async () => {
        ...
        const testImageData = fs.createReadStream(`src/packages/workspace-redux/test/assets/images/${testFileName}`);
    ...
    it('getFilePublicLink', async () => {
        ...
        nock(Client4.getBaseRoute()).
            ...
            query(true).
            reply(200, {
                link: 'https://workspace.com/files/ndans23ry2rtjd1z73g6i5f3fc/public?h=rE1-b2N1VVVMsAQssjwlfNawbVOwUy1TRDuTeGC_tys',
            });
        ...
        expect('https://workspace.com/files/ndans23ry2rtjd1z73g6i5f3fc/public?h=rE1-b2N1VVVMsAQssjwlfNawbVOwUy1TRDuTeGC_tys').toEqual(filePublicLink);
