...
import type {OrderedChannelCategories, ChannelCategory} from '@workspace/types/channel_categories';
import {CategorySorting} from '@workspace/types/channel_categories';
import type {Channel} from '@workspace/types/channels';

import {ChannelCategoryTypes, ChannelTypes} from 'workspace-redux/action_types';
...
} from 'workspace-redux/selectors/entities/channel_categories';
import {getCurrentUserId} from 'workspace-redux/selectors/entities/users';
import type {
    ActionFuncAsync,
    ThunkActionFunc,
} from 'workspace-redux/types/actions';
import {insertMultipleWithoutDuplicates, insertWithoutDuplicates, removeItem} from 'workspace-redux/utils/array_utils';
