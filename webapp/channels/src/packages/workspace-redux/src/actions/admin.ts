...
import type {LogFilter} from '@workspace/types/admin';
import type {
    Channel,
    ChannelSearchOpts,
} from '@workspace/types/channels';
import type {Compliance} from '@workspace/types/compliance';
import type {AdminConfig, AllowedIPRange, LdapSettings} from '@workspace/types/config';
import type {
...
import type {GroupSearchOpts} from '@workspace/types/groups';
