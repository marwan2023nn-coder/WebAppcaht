...
import {ChannelBookmarkTypes} from 'workspace-redux/action_types';
import {Client4} from 'workspace-redux/client';
import {getChannelBookmark} from 'workspace-redux/selectors/entities/channel_bookmarks';
import type {ActionFuncAsync, DispatchFunc} from 'workspace-redux/types/actions';
