...
import {PreferenceTypes} from 'workspace-redux/action_types';
import {Client4} from 'workspace-redux/client';
import {getMyPreferences as getMyPreferencesSelector, getThemePreferences} from 'workspace-redux/selectors/entities/preferences';
...
import type {ActionFuncAsync, ThunkActionFunc} from 'workspace-redux/types/actions';
