...
import {AdminTypes, ChannelTypes, UserTypes, SchemeTypes, GroupTypes, PostTypes} from 'workspace-redux/action_types';
import {General} from 'workspace-redux/constants';
import {MarkUnread} from 'workspace-redux/constants/channels';
import {channelListToMap, splitRoles} from 'workspace-redux/utils/channel_utils';
...
function receiveChannelMember(state: RelationOneToOne<Channel, ChannelMembership>, received: ChannelMembership) {
    ...
    // https://github.com/workspace/workspace-webapp/pull/10589 and
    // https://github.com/workspace/workspace-webapp/pull/11094
