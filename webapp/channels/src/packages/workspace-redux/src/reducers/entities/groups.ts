...
import type {GroupChannel, GroupSyncablesState, GroupTeam, Group, GroupMember} from '@workspace/types/groups';

import type {MMReduxAction} from 'workspace-redux/action_types';
import {GroupTypes} from 'workspace-redux/action_types';
