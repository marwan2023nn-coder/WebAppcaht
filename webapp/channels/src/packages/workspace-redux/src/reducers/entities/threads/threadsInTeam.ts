...
import type {ThreadsState, UserThread, UserThreadWithPost} from '@workspace/types/threads';
...
import {ChannelTypes, PostTypes, TeamTypes, ThreadTypes, UserTypes} from 'workspace-redux/action_types';
