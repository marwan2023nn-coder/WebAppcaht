...
import type {ChannelBookmark, ChannelBookmarksState} from '@workspace/types/channel_bookmarks';
...
import {ChannelBookmarkTypes, UserTypes, ChannelTypes} from 'workspace-redux/action_types';
