...
import type {ChannelBookmark} from '@workspace/types/channel_bookmarks';
...
import {FileTypes, PostTypes, UserTypes, ChannelBookmarkTypes} from 'workspace-redux/action_types';
