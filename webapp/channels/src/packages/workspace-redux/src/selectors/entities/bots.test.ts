...
import * as Selectors from 'workspace-redux/selectors/entities/bots';
...
describe('Selectors.Bots', () => {
    ...
    const otherUser2 = {id: userID3, username: 'workspace-advisor', first_name: 'Another', last_name: 'User', locale: 'en'};
