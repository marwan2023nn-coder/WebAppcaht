...
import deepFreezeAndThrowOnMutation from 'workspace-redux/utils/deep_freeze';
import {sortByUsername} from 'workspace-redux/utils/user_utils';
...
describe('Selectors.Users', () => {
    ...
    user1.position = 'Software Engineer at Workspace';
    ...
    it('searchProfilesInCurrentChannel', () => {
        ...
        expect(Selectors.searchProfilesInCurrentChannel(testState, 'engineer at workspace')).toEqual([user1]);
