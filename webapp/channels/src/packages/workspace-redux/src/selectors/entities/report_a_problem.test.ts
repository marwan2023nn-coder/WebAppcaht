...
import {getBrowserInfo} from 'workspace-redux/utils/browser_info';

import {getReportAProblemLink, getSystemInfoMailtoLink} from './report_a_problem';

jest.mock('workspace-redux/utils/browser_info', () => ({
...
describe('getReportAProblemLink', () => {
    ...
    it('should return the default value if licensed', () => {
        ...
        expect(getReportAProblemLink(state)).toContain('https://workspace.com/pl/report_a_problem_licensed');
    });
    ...
    it('should return the default value if unlicensed', () => {
        ...
        expect(getReportAProblemLink(state)).toContain('https://workspace.com/pl/report_a_problem_unlicensed');
    });
});
