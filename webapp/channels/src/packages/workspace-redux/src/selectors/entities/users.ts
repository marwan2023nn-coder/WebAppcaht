...
import {getDirectShowPreferences, getTeammateNameDisplaySetting} from 'workspace-redux/selectors/entities/preferences';
...
import {
    ...
    isGuest,
    applyRolesFilters,
} from 'workspace-redux/utils/user_utils';
