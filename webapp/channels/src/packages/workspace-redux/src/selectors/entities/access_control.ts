...
import type {Channel, ChannelWithTeamData, ChannelSearchOpts} from '@workspace/types/channels';
...
import {filterChannelsMatchingTerm} from 'workspace-redux/utils/channel_utils';
