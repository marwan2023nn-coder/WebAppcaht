...
import type {LegacyThemeType, Theme, ThemeKey, ThemeType} from 'workspace-redux/selectors/entities/preferences';
...
type ThemeTypeMap = Record<string, ThemeKey>;
