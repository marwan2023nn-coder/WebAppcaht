...
describe('utils/browser_info', () => {
    ...
    describe('getBrowserInfo', () => {
        const browserTestCases = [
            {
                name: 'Workspace Desktop App',
                userAgent: 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/132.0.6834.83 Electron/34.0.1 Safari/537.36 Workspace/34.0.1',
                expectedBrowser: 'Workspace Desktop App',
