...
import {checkDialogElementForError, checkIfErrorsMatchElements} from 'workspace-redux/utils/integration_utils';
...
describe('integration utils', () => {
    describe('checkDialogElementForError', () => {
        ...
        it('should return null on good email element', () => {
            expect(checkDialogElementForError(TestHelper.getDialogElementMock({type: 'text', subtype: 'email'}), 'joram@workspace.com')).toBe(null);
        });
        ...
        it('should return null on good url element', () => {
            expect(checkDialogElementForError(TestHelper.getDialogElementMock({type: 'text', subtype: 'url'}), 'http://workspace.com')).toBe(null);
            expect(checkDialogElementForError(TestHelper.getDialogElementMock({type: 'text', subtype: 'url'}), 'https://workspace.com')).toBe(null);
        });
