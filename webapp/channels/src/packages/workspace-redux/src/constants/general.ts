...
export default {
    ...
    PROFILE_CHUNK_SIZE: 100, // WARN: Do not change this without changing the cache key on server side as well. See https://github.com/workspace/workspace/pull/26391.
    ...
    DEFAULT_LOCALE: 'ar',
    DEFAULT_AUTOLINKED_URL_SCHEMES: ['http', 'https', 'ftp', 'mailto', 'tel', 'workspace'],
    DISABLED: 'disabled',
