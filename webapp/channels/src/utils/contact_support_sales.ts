...
const baseZendeskFormURL = 'https://local-workspace.sofa.ye/';
...
export const goToWorkspaceContactSalesForm = (firstName: string, lastName: string, companyName: string, businessEmail: string, source: string, medium: string) => {
