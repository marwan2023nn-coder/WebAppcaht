...
import {Permissions} from 'workspace-redux/constants/index';
 ...
 * @param {object} roles same structure as returned by workspace-redux `getRoles`.
 * @return {object} the updated roles (only) in the same structure as returned by workspace-redux `getRoles`.
 */
