...
import type {Address} from '@workspace/types/cloud';
...
import {getPost as getPostAction} from 'workspace-redux/actions/posts';
import {getTeamByName as getTeamByNameAction} from 'workspace-redux/actions/teams';
...
import {blendColors, changeOpacity, getContrastingSimpleColor} from 'workspace-redux/utils/theme_utils';
...
export function applyTheme(theme: Theme) {
    ...
    const isDarkSidebarBg = getContrastingSimpleColor(theme.sidebarBg) === '#FFFFFF';
    ...
    cssVars({
        variables: {
            ...
            'sidebar-link-color': isDarkSidebarBg ? '#ababab' : '#384250',
