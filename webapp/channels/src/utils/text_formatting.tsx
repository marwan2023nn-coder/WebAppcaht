...
import type {SystemEmoji} from '@workspace/types/emojis';
import {isRecordOf} from '@workspace/types/utilities';

import type {HighlightWithoutNotificationKey} from 'workspace-redux/selectors/entities/users';
...
export interface TextFormattingOptionsBase {
    ...
    /**
     * The origin of this Workspace instance.
     *
...
function preserveMultipleBlankLinesOutsideFencedCodeBlocks(text: string): string {
    if (!text.includes('\n\n\n')) {
        return text;
    }
...
export function formatText(
    ...
    if (options.renderer) {
        ...
        if (!options.singleline) {
            output = preserveMultipleBlankLinesOutsideFencedCodeBlocks(output);
        }
