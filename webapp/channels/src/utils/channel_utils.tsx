...
import {ArchiveLockOutlineIcon, ArchiveOutlineIcon, GlobeIcon, LockOutlineIcon} from '@workspace/compass-icons/components';
...
import {removeUserFromTeam} from 'workspace-redux/actions/teams';
import Permissions from 'workspace-redux/constants/permissions';
import {getRedirectChannelNameForTeam} from 'workspace-redux/selectors/entities/channels';
