...
export default class A11yController {
    ...
    // This behaviour was introduced in https://github.com/workspace/workspace-webapp/pull/3922.
    ...
    handleFocus = (event: Event) => {
        if (event.target instanceof HTMLElement) {
            ...
            // @see: https://github.com/workspace/workspace-webapp/pull/8882#discussion_r790905592
