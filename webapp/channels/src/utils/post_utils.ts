...
import type {Post, PostPriorityMetadata} from '@workspace/types/posts';
import {PostPriority} from '@workspace/types/posts';
...
import {Permissions, Posts} from 'workspace-redux/constants';
...
import {getAllGroupsForReferenceByName} from 'workspace-redux/selectors/entities/groups';
import {isPostFlagged, makeGetReactionsForPost} from 'workspace-redux/selectors/entities/posts';
import {getTeammateNameDisplaySetting, isCollapsedThreadsEnabled} from 'workspace-redux/selectors/entities/preferences';
import {haveIChannelPermission} from 'workspace-redux/selectors/entities/roles';
import {getCurrentTeamId, getTeam} from 'workspace-redux/selectors/entities/teams';
import {makeGetDisplayName, getCurrentUserId, getUser, getUsersByUsername} from 'workspace-redux/selectors/entities/users';
...
import {canEditPost as canEditPostRedux} from 'workspace-redux/utils/post_utils';
...
// workspace-redux, except it also includes additional special IDs that are only used in the web app.
