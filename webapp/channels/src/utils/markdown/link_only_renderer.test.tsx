...
describe('formatWithRenderer | LinkOnlyRenderer', () => {
    const testCases = [
        ...
        },
        {
            ...
            inputText: '###### H6 header\n[link 1](https://workspace.com) - [link 2](https://workspace.com)',
            outputText: 'H6 header <a class="theme markdown__link" href="https://workspace.com" target="_blank">' +
            'link 1</a> - <a class="theme markdown__link" href="https://workspace.com" target="_blank">link 2</a>',
        },
        {
        ...
        },
        {
            ...
            inputText: 'Do you like www.workspace.com?',
            outputText: 'Do you like <a class="theme markdown__link" href="http://www.workspace.com" target="_blank">' +
            'www.workspace.com</a>?',
        },
        {
            description: 'link: link with a scheme',
            inputText: 'Do you like http://www.workspace.com?',
            outputText: 'Do you like <a class="theme markdown__link" href="http://www.workspace.com" target="_blank">' +
            'http://www.workspace.com</a>?',
        },
        {
            description: 'link: link with a title',
            inputText: 'Do you like [Workspace](http://www.workspace.com)?',
            outputText: 'Do you like <a class="theme markdown__link" href="http://www.workspace.com" target="_blank">' +
            'Workspace</a>?',
        },
        {
        ...
        },
        {
            ...
            inputText: 'Do you like https://workspace.com/，這是第二個網址。?',
            outputText: 'Do you like <a class="theme markdown__link" href="https://workspace.com/" target="_blank">' +
                'https://workspace.com/</a>，這是第二個網址。?',
        },
    ];
