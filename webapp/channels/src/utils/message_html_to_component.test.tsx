...
`;
    ...
    test('Inline markdown image', () => {
        ...
        const html = TextFormatting.formatText('![Workspace](/images/icon.png) and a [link](link)', options, emptyEmojiMap);
    ...
    test('Inline markdown image where image is link', () => {
        const options = {markdown: true};
        const html = TextFormatting.formatText('[![Workspace](images/icon.png)](images/icon.png)', options, emptyEmojiMap);
