...
describe('Utils.getFileType', () => {
    ...
    test('should identify image files from URLs without extensions', () => {
        ...
        expect(getFileType('https://workspace.com/api/v4/image?url=https://example.com/another-image')).toBe(FileTypes.IMAGE);
        ...
        expect(getFileType('https://workspace.com/api/v4/image?param=value&url=https://example.com/image')).toBe(FileTypes.IMAGE);
    });
    ...
    test('should identify image files from proxied URLs', () => {
        ...
        expect(getFileType('https://workspace.com/api/v4/image?url=https://example.com/image.png')).toBe(FileTypes.IMAGE);
    });
