...
import type {GlobalState as BaseGlobalState} from '@workspace/types/store';

import type {MMReduxAction} from 'workspace-redux/action_types';
// eslint-disable-next-line @typescript-eslint/no-restricted-imports
import type * as MMReduxTypes from 'workspace-redux/types/actions';

import type {PluginsState} from './plugins';
import type {StorageState} from './storage';
import type {ViewsState} from './views';

import type {AudioState} from 'reducers/audio_reducer';
import type {ReplyBoxState} from 'reducers/reply_box';
import type {FocusPostState} from 'reducers/focus_post';
...
export type GlobalState = BaseGlobalState & {
    ...
    focusPost: FocusPostState;
};

/**
 * An MMAction is any non-Thunk Redux action accepted by the web app and workspace-redux.
 */
