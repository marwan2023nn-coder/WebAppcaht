...
import type {IconGlyphTypes} from '@workspace/compass-icons/IconGlyphs';
import type {PluginAnalyticsRow} from '@workspace/types/admin';
import type {Board} from '@workspace/types/boards';
...
import type {ClientPluginManifest} from '@workspace/types/plugins';
import type {Post, PostEmbed} from '@workspace/types/posts';
import type {ProductScope} from '@workspace/types/products';
...
export type ChannelHeaderIconComponent = PluginComponent & {
    component: React.ComponentType<{channel: Channel; channelMember: ChannelMembership}>;
};
