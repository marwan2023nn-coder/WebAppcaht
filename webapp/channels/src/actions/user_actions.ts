...
import type {UserProfile, UserStatus} from '@workspace/types/users';

import {getChannelAndMyMember, getChannelMembersByIds} from 'workspace-redux/actions/channels';
import {savePreferences} from 'workspace-redux/actions/preferences';
import {getTeamMembersByIds} from 'workspace-redux/actions/teams';
import * as UserActions from 'workspace-redux/actions/users';
import {Preferences as PreferencesRedux, General} from 'workspace-redux/constants';
import {
    getChannel,
...
import {getBool, isCollapsedThreadsEnabled} from 'workspace-redux/selectors/entities/preferences';
import {getCurrentTeamId, getTeamMember} from 'workspace-redux/selectors/entities/teams';
import * as Selectors from 'workspace-redux/selectors/entities/users';
