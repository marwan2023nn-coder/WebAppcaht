...
import {TeamTypes} from 'workspace-redux/action_types';
import {
...
import {selectTeam} from 'workspace-redux/actions/teams';
import {autocompleteUsers} from 'workspace-redux/actions/users';
import {Posts, RequestStatus} from 'workspace-redux/constants';
import {
    getChannel,
...
import {getCurrentUserId, getUserByUsername} from 'workspace-redux/selectors/entities/users';
import {makeAddLastViewAtToProfiles} from 'workspace-redux/selectors/entities/utils';
import {getChannelByName} from 'workspace-redux/utils/channel_utils';
