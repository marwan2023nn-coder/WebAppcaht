...
import * as SearchActions from 'workspace-redux/actions/search';
...
const UserSelectors = require('workspace-redux/selectors/entities/users');
UserSelectors.getCurrentUserMentionKeys = jest.fn(() => [{key: '@here'}, {key: '@workspace'}, {key: '@channel'}, {key: '@all'}]);
...
jest.mock('workspace-redux/actions/search', () => ({
...
describe('rhs view actions', () => {
    ...
    describe('showMentions', () => {
        test('it dispatches the right actions', () => {
            ...
            compareStore.dispatch(performSearch('@workspace ', '', true));
