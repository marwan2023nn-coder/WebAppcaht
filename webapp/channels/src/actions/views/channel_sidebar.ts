...
import {createCategory as createCategoryRedux, moveChannelsToCategory} from 'workspace-redux/actions/channel_categories';
import {General} from 'workspace-redux/constants';
import {CategoryTypes} from 'workspace-redux/constants/channel_categories';
import {getCategory, makeGetChannelIdsForCategory} from 'workspace-redux/selectors/entities/channel_categories';
import {getCurrentChannelId} from 'workspace-redux/selectors/entities/channels';
import {insertMultipleWithoutDuplicates} from 'workspace-redux/utils/array_utils';
