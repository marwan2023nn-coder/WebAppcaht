...
import {leaveChannel, markChannelAsRead, getChannel} from 'workspace-redux/actions/channels';
import * as PostActions from 'workspace-redux/actions/posts';
import * as UserActions from 'workspace-redux/actions/users';
import {General, Posts, RequestStatus} from 'workspace-redux/constants';
...
jest.mock('workspace-redux/actions/channels', () => ({
    ...jest.requireActual('workspace-redux/actions/channels'),
...
jest.mock('workspace-redux/selectors/entities/utils', () => ({
