...
import {getSortedTrackedSelectors} from 'workspace-redux/selectors/create_selector';
...
export function trackEvent(category, event, props = {}) {
    ...
    if (typeof Client4.trackEvent === 'function') {
