...
import {ChannelTypes} from 'workspace-redux/action_types';
import {fetchAppBindings} from 'workspace-redux/actions/apps';
import {
...
import {logout, loadMe} from 'workspace-redux/actions/users';
import {Preferences} from 'workspace-redux/constants';
import {appsEnabled} from 'workspace-redux/selectors/entities/apps';
import {getCurrentChannelStats, getCurrentChannelId, getMyChannelMember, getRedirectChannelNameForTeam, getChannelsNameMapInTeam, getAllDirectChannels, getChannelMessageCount} from 'workspace-redux/selectors/entities/channels';
import {getConfig, isPerformanceDebuggingEnabled} from 'workspace-redux/selectors/entities/general';
import {getBool, getIsOnboardingFlowEnabled, isCollapsedThreadsEnabled} from 'workspace-redux/selectors/entities/preferences';
import {getCurrentTeamId, getMyTeams, getTeam, getMyTeamMember, getTeamMemberships, getActiveTeamsList} from 'workspace-redux/selectors/entities/teams';
import {getCurrentUser, getCurrentUserId, isFirstAdmin} from 'workspace-redux/selectors/entities/users';
import {calculateUnreadCount} from 'workspace-redux/utils/channel_utils';
...
export function emitChannelClickEvent(channel: Channel) {
    function switchToChannel(chan: Channel) {
        ...
        dispatch(batchActions([
            {
                type: ActionTypes.CLEAR_MULTISELECT_POSTS,
            },
            {
                type: ActionTypes.SET_POST_MULTISELECT_MODE,
                data: {enabled: false},
            },
            {
