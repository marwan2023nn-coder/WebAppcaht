...
import type {IncomingWebhook, IncomingWebhooksWithCount, OutgoingWebhook, Command, OAuthApp, OutgoingOAuthConnection, DialogSubmission, SubmitDialogResponse} from '@workspace/types/integrations';
...
import {getDialogArguments} from 'workspace-redux/selectors/entities/integrations';
