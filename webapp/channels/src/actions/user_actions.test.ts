...
import {Preferences, General} from 'workspace-redux/constants';
...
import TestHelper from 'packages/workspace-redux/test/test_helper';
...
jest.mock('workspace-redux/actions/channels', () => {
    const original = jest.requireActual('workspace-redux/actions/channels');
    return {
        ...original,
