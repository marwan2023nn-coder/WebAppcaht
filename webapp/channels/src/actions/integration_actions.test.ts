...
import type {IncomingWebhook, OutgoingWebhook, Command, OAuthApp} from '@workspace/types/integrations';

import * as IntegrationActions from 'workspace-redux/actions/integrations';
...
jest.mock('workspace-redux/actions/integrations', () => ({
...
jest.mock('workspace-redux/selectors/entities/apps', () => ({
    appsEnabled: jest.fn(() => true),
}));

jest.mock('workspace-redux/selectors/entities/integrations', () => ({
...
describe('actions/integration_actions', () => {
    ...
    describe('submitInteractiveDialog', () => {
        test('submitInteractiveDialog with current channel', async () => {
            const {getDialogArguments} = require('workspace-redux/selectors/entities/integrations');
            const testState = {
                ...initialState,
                entities: {
