...
// restarting or by running the `workspace config subpath` command.
...
// Define the subpath at which Workspace is running. Extract this from the publicPath above to
