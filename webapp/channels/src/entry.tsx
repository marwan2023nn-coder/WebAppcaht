...
import {logError, LogErrorBarMode} from 'workspace-redux/actions/errors';
...
import '@workspace/compass-icons/css/compass-icons.css';
import '@workspace/components/dist/index.esm.css';
